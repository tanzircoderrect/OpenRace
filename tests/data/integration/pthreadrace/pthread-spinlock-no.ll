; ModuleID = 'integration/pthreadrace/pthread-spinlock-no.cpp'
source_filename = "integration/pthreadrace/pthread-spinlock-no.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_pthread_spinlock_no.cpp, i8* null }]
...
delete.end:                                       ; preds = %delete.notnull, %while.body
  ...
  %call2 = call i32 @pthread_spin_unlock(i32* @_ZL4lock) #7, !dbg !1095
  br label %while.body, !dbg !1088, !llvm.loop !1096
}
...
; Function Attrs: uwtable
define internal void @__cxx_global_var_init() #5 section ".text.startup" !dbg !1098 {
entry:
  call void @_ZNSt8ios_base4InitC1Ev(%"class.std::ios_base::Init"* @_ZStL8__ioinit), !dbg !1099
  %0 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::ios_base::Init"*)* @_ZNSt8ios_base4InitD1Ev to void (i8*)*), i8* getelementptr inbounds (%"class.std::ios_base::Init", %"class.std::ios_base::Init"* @_ZStL8__ioinit, i32 0, i32 0), i8* @__dso_handle) #7, !dbg !1099
  ret void, !dbg !1099
}
...
define available_externally dso_local dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %__out, i8* %__s) #8 !dbg !1100 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %"class.std::basic_ostream"** %__out.addr, metadata !1108, metadata !DIExpression()), !dbg !1165
  store i8* %__s, i8** %__s.addr, align 8, !tbaa !1029
  call void @llvm.dbg.declare(metadata i8** %__s.addr, metadata !1109, metadata !DIExpression()), !dbg !1166
  %0 = load i8*, i8** %__s.addr, align 8, !dbg !1167, !tbaa !1029
  %tobool = icmp ne i8* %0, null, !dbg !1167
  br i1 %tobool, label %if.else, label %if.then, !dbg !1169

if.then:                                          ; preds = %entry
  %1 = load %"class.std::basic_ostream"*, %"class.std::basic_ostream"** %__out.addr, align 8, !dbg !1170, !tbaa !1029
  %2 = bitcast %"class.std::basic_ostream"* %1 to i8**, !dbg !1170
  %vtable = load i8*, i8** %2, align 8, !dbg !1170, !tbaa !1171
  %vbase.offset.ptr = getelementptr i8, i8* %vtable, i64 -24, !dbg !1170
  %3 = bitcast i8* %vbase.offset.ptr to i64*, !dbg !1170
  %vbase.offset = load i64, i64* %3, align 8, !dbg !1170
  %4 = bitcast %"class.std::basic_ostream"* %1 to i8*, !dbg !1170
  %add.ptr = getelementptr inbounds i8, i8* %4, i64 %vbase.offset, !dbg !1170
  %5 = bitcast i8* %add.ptr to %"class.std::basic_ios"*, !dbg !1170
  call void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(%"class.std::basic_ios"* %5, i32 1), !dbg !1173
  br label %if.end, !dbg !1170

if.else:                                          ; preds = %entry
  %6 = load %"class.std::basic_ostream"*, %"class.std::basic_ostream"** %__out.addr, align 8, !dbg !1174, !tbaa !1029
  %7 = load i8*, i8** %__s.addr, align 8, !dbg !1175, !tbaa !1029
  %8 = load i8*, i8** %__s.addr, align 8, !dbg !1176, !tbaa !1029
  %call = call i64 @_ZNSt11char_traitsIcE6lengthEPKc(i8* %8), !dbg !1177
  %call1 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(%"class.std::basic_ostream"* dereferenceable(272) %6, i8* %7, i64 %call), !dbg !1178
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %9 = load %"class.std::basic_ostream"*, %"class.std::basic_ostream"** %__out.addr, align 8, !dbg !1179, !tbaa !1029
  ret %"class.std::basic_ostream"* %9, !dbg !1180
}

; Function Attrs: uwtable
define available_externally dso_local dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEj(%"class.std::basic_ostream"* %this, i32 %__n) #5 align 2 !dbg !1181 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %"class.std::basic_ostream"** %this.addr, metadata !1189, metadata !DIExpression()), !dbg !1192
  store i32 %__n, i32* %__n.addr, align 4, !tbaa !1024
  call void @llvm.dbg.declare(metadata i32* %__n.addr, metadata !1191, metadata !DIExpression()), !dbg !1193
  %this1 = load %"class.std::basic_ostream"*, %"class.std::basic_ostream"** %this.addr, align 8
  %0 = load i32, i32* %__n.addr, align 4, !dbg !1194, !tbaa !1024
  %conv = zext i32 %0 to i64, !dbg !1194
  %call = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSo9_M_insertImEERSoT_(%"class.std::basic_ostream"* %this1, i64 %conv), !dbg !1195
  ret %"class.std::basic_ostream"* %call, !dbg !1196
}
...
; Function Attrs: uwtable
define available_externally dso_local void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(%"class.std::basic_ios"* %this, i32 %__state) #5 align 2 !dbg !1197 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %"class.std::basic_ios"** %this.addr, metadata !1207, metadata !DIExpression()), !dbg !1210
  store i32 %__state, i32* %__state.addr, align 4, !tbaa !1211
  call void @llvm.dbg.declare(metadata i32* %__state.addr, metadata !1209, metadata !DIExpression()), !dbg !1213
  %this1 = load %"class.std::basic_ios"*, %"class.std::basic_ios"** %this.addr, align 8
  %call = call i32 @_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv(%"class.std::basic_ios"* %this1), !dbg !1214
  %0 = load i32, i32* %__state.addr, align 4, !dbg !1215, !tbaa !1211
  %call2 = call i32 @_ZStorSt12_Ios_IostateS_(i32 %call, i32 %0), !dbg !1216
  call void @_ZNSt9basic_iosIcSt11char_traitsIcEE5clearESt12_Ios_Iostate(%"class.std::basic_ios"* %this1, i32 %call2), !dbg !1217
  ret void, !dbg !1218
}
...
define linkonce_odr dso_local i64 @_ZNSt11char_traitsIcE6lengthEPKc(i8* %__s) #9 comdat align 2 !dbg !1219 {
entry:
  %__s.addr = alloca i8*, align 8
  store i8* %__s, i8** %__s.addr, align 8, !tbaa !1029
  call void @llvm.dbg.declare(metadata i8** %__s.addr, metadata !1221, metadata !DIExpression()), !dbg !1222
  %0 = load i8*, i8** %__s.addr, align 8, !dbg !1223, !tbaa !1029
  %call = call i64 @strlen(i8* %0) #7, !dbg !1224
  ret i64 %call, !dbg !1225
}

declare dso_local void @_ZNSt9basic_iosIcSt11char_traitsIcEE5clearESt12_Ios_Iostate(%"class.std::basic_ios"*, i32) #6

; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local i32 @_ZStorSt12_Ios_IostateS_(i32 %__a, i32 %__b) #10 comdat !dbg !1226 {
entry:
  %__a.addr = alloca i32, align 4
  %__b.addr = alloca i32, align 4
  store i32 %__a, i32* %__a.addr, align 4, !tbaa !1211
  call void @llvm.dbg.declare(metadata i32* %__a.addr, metadata !1230, metadata !DIExpression()), !dbg !1232
  store i32 %__b, i32* %__b.addr, align 4, !tbaa !1211
  call void @llvm.dbg.declare(metadata i32* %__b.addr, metadata !1231, metadata !DIExpression()), !dbg !1233
  %0 = load i32, i32* %__a.addr, align 4, !dbg !1234, !tbaa !1211
  %1 = load i32, i32* %__b.addr, align 4, !dbg !1235, !tbaa !1211
  %or = or i32 %0, %1, !dbg !1236
  ret i32 %or, !dbg !1237
}

; Function Attrs: nounwind uwtable
define available_externally dso_local i32 @_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv(%"class.std::basic_ios"* %this) #9 align 2 !dbg !1238 {
entry:
  %this.addr = alloca %"class.std::basic_ios"*, align 8
  store %"class.std::basic_ios"* %this, %"class.std::basic_ios"** %this.addr, align 8, !tbaa !1029
  call void @llvm.dbg.declare(metadata %"class.std::basic_ios"** %this.addr, metadata !1245, metadata !DIExpression()), !dbg !1247
  %this1 = load %"class.std::basic_ios"*, %"class.std::basic_ios"** %this.addr, align 8
  %0 = bitcast %"class.std::basic_ios"* %this1 to %"class.std::ios_base"*, !dbg !1248
  %_M_streambuf_state = getelementptr inbounds %"class.std::ios_base", %"class.std::ios_base"* %0, i32 0, i32 5, !dbg !1248
  %1 = load i32, i32* %_M_streambuf_state, align 8, !dbg !1248, !tbaa !1249
  ret i32 %1, !dbg !1254
}
...
; Function Attrs: uwtable
define internal void @_GLOBAL__sub_I_pthread_spinlock_no.cpp() #5 section ".text.startup" !dbg !1255 {
entry:
  call void @__cxx_global_var_init(), !dbg !1257
  ret void
}
...
!3 = !DIFile(filename: "integration/pthreadrace/pthread-spinlock-no.cpp", directory: "/home/brad/Code/OpenRace/tests/data")
!4 = !{!5, !11}
...
!1095 = !DILocation(line: 31, column: 5, scope: !1090)
!1096 = distinct !{!1096, !1088, !1097}
!1097 = !DILocation(line: 32, column: 3, scope: !1084)
!1098 = distinct !DISubprogram(name: "__cxx_global_var_init", scope: !49, file: !49, line: 74, type: !616, scopeLine: 74, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !29)
!1099 = !DILocation(line: 74, column: 25, scope: !1098)
!1100 = distinct !DISubprogram(name: "operator<<<std::char_traits<char> >", linkageName: "_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc", scope: !13, file: !1101, line: 606, type: !1102, scopeLine: 607, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, templateParams: !1110, retainedNodes: !1107)
!1101 = !DIFile(filename: "/usr/lib64/gcc/x86_64-pc-linux-gnu/10.2.0/../../../../include/c++/10.2.0/ostream", directory: "")
!1102 = !DISubroutineType(types: !1103)
!1103 = !{!1104, !1104, !204}
!1104 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1105, size: 64)
!1105 = !DICompositeType(tag: DW_TAG_class_type, name: "basic_ostream<char, std::char_traits<char> >", scope: !13, file: !1106, line: 359, flags: DIFlagFwdDecl)
!1106 = !DIFile(filename: "/usr/lib64/gcc/x86_64-pc-linux-gnu/10.2.0/../../../../include/c++/10.2.0/bits/ostream.tcc", directory: "")
!1107 = !{!1108, !1109}
!1108 = !DILocalVariable(name: "__out", arg: 1, scope: !1100, file: !1101, line: 606, type: !1104)
!1109 = !DILocalVariable(name: "__s", arg: 2, scope: !1100, file: !1101, line: 606, type: !204)
!1110 = !{!1111}
!1111 = !DITemplateTypeParameter(name: "_Traits", type: !1112)
!1112 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "char_traits<char>", scope: !13, file: !1113, line: 309, size: 8, flags: DIFlagTypePassByValue, elements: !1114, templateParams: !1163, identifier: "_ZTSSt11char_traitsIcE")
!1113 = !DIFile(filename: "/usr/lib64/gcc/x86_64-pc-linux-gnu/10.2.0/../../../../include/c++/10.2.0/bits/char_traits.h", directory: "")
!1114 = !{!1115, !1122, !1125, !1126, !1131, !1134, !1137, !1141, !1142, !1145, !1151, !1154, !1157, !1160}
!1115 = !DISubprogram(name: "assign", linkageName: "_ZNSt11char_traitsIcE6assignERcRKc", scope: !1112, file: !1113, line: 321, type: !1116, scopeLine: 321, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1116 = !DISubroutineType(types: !1117)
!1117 = !{null, !1118, !1120}
!1118 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1119, size: 64)
!1119 = !DIDerivedType(tag: DW_TAG_typedef, name: "char_type", scope: !1112, file: !1113, line: 311, baseType: !90)
!1120 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1121, size: 64)
!1121 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1119)
!1122 = !DISubprogram(name: "eq", linkageName: "_ZNSt11char_traitsIcE2eqERKcS2_", scope: !1112, file: !1113, line: 325, type: !1123, scopeLine: 325, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1123 = !DISubroutineType(types: !1124)
!1124 = !{!56, !1120, !1120}
!1125 = !DISubprogram(name: "lt", linkageName: "_ZNSt11char_traitsIcE2ltERKcS2_", scope: !1112, file: !1113, line: 329, type: !1123, scopeLine: 329, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1126 = !DISubprogram(name: "compare", linkageName: "_ZNSt11char_traitsIcE7compareEPKcS2_m", scope: !1112, file: !1113, line: 337, type: !1127, scopeLine: 337, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1127 = !DISubroutineType(types: !1128)
!1128 = !{!14, !1129, !1129, !1130}
!1129 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1121, size: 64)
!1130 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", scope: !13, file: !43, line: 260, baseType: !33)
!1131 = !DISubprogram(name: "length", linkageName: "_ZNSt11char_traitsIcE6lengthEPKc", scope: !1112, file: !1113, line: 351, type: !1132, scopeLine: 351, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1132 = !DISubroutineType(types: !1133)
!1133 = !{!1130, !1129}
!1134 = !DISubprogram(name: "find", linkageName: "_ZNSt11char_traitsIcE4findEPKcmRS1_", scope: !1112, file: !1113, line: 361, type: !1135, scopeLine: 361, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1135 = !DISubroutineType(types: !1136)
!1136 = !{!1129, !1129, !1130, !1120}
!1137 = !DISubprogram(name: "move", linkageName: "_ZNSt11char_traitsIcE4moveEPcPKcm", scope: !1112, file: !1113, line: 375, type: !1138, scopeLine: 375, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1138 = !DISubroutineType(types: !1139)
!1139 = !{!1140, !1140, !1129, !1130}
!1140 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1119, size: 64)
!1141 = !DISubprogram(name: "copy", linkageName: "_ZNSt11char_traitsIcE4copyEPcPKcm", scope: !1112, file: !1113, line: 387, type: !1138, scopeLine: 387, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1142 = !DISubprogram(name: "assign", linkageName: "_ZNSt11char_traitsIcE6assignEPcmc", scope: !1112, file: !1113, line: 399, type: !1143, scopeLine: 399, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1143 = !DISubroutineType(types: !1144)
!1144 = !{!1140, !1140, !1130, !1119}
!1145 = !DISubprogram(name: "to_char_type", linkageName: "_ZNSt11char_traitsIcE12to_char_typeERKi", scope: !1112, file: !1113, line: 411, type: !1146, scopeLine: 411, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
...
!1150 = !DIDerivedType(tag: DW_TAG_typedef, name: "int_type", scope: !1112, file: !1113, line: 312, baseType: !14)
!1151 = !DISubprogram(name: "to_int_type", linkageName: "_ZNSt11char_traitsIcE11to_int_typeERKc", scope: !1112, file: !1113, line: 417, type: !1152, scopeLine: 417, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1152 = !DISubroutineType(types: !1153)
!1153 = !{!1150, !1120}
!1154 = !DISubprogram(name: "eq_int_type", linkageName: "_ZNSt11char_traitsIcE11eq_int_typeERKiS2_", scope: !1112, file: !1113, line: 421, type: !1155, scopeLine: 421, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1155 = !DISubroutineType(types: !1156)
!1156 = !{!56, !1148, !1148}
!1157 = !DISubprogram(name: "eof", linkageName: "_ZNSt11char_traitsIcE3eofEv", scope: !1112, file: !1113, line: 425, type: !1158, scopeLine: 425, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1158 = !DISubroutineType(types: !1159)
!1159 = !{!1150}
!1160 = !DISubprogram(name: "not_eof", linkageName: "_ZNSt11char_traitsIcE7not_eofERKi", scope: !1112, file: !1113, line: 429, type: !1161, scopeLine: 429, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1161 = !DISubroutineType(types: !1162)
!1162 = !{!1150, !1148}
!1163 = !{!1164}
!1164 = !DITemplateTypeParameter(name: "_CharT", type: !90)
!1165 = !DILocation(line: 606, column: 46, scope: !1100)
!1166 = !DILocation(line: 606, column: 65, scope: !1100)
!1167 = !DILocation(line: 608, column: 12, scope: !1168)
!1168 = distinct !DILexicalBlock(scope: !1100, file: !1101, line: 608, column: 11)
!1169 = !DILocation(line: 608, column: 11, scope: !1100)
!1170 = !DILocation(line: 609, column: 2, scope: !1168)
!1171 = !{!1172, !1172, i64 0}
!1172 = !{!"vtable pointer", !1027, i64 0}
!1173 = !DILocation(line: 609, column: 8, scope: !1168)
!1174 = !DILocation(line: 611, column: 19, scope: !1168)
!1175 = !DILocation(line: 611, column: 26, scope: !1168)
!1176 = !DILocation(line: 612, column: 45, scope: !1168)
!1177 = !DILocation(line: 612, column: 29, scope: !1168)
!1178 = !DILocation(line: 611, column: 2, scope: !1168)
!1179 = !DILocation(line: 613, column: 14, scope: !1100)
!1180 = !DILocation(line: 613, column: 7, scope: !1100)
!1181 = distinct !DISubprogram(name: "operator<<", linkageName: "_ZNSolsEj", scope: !1105, file: !1101, line: 192, type: !1182, scopeLine: 193, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, declaration: !1187, retainedNodes: !1188)
!1182 = !DISubroutineType(types: !1183)
!1183 = !{!1184, !1186, !7}
!1184 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1185, size: 64)
!1185 = !DIDerivedType(tag: DW_TAG_typedef, name: "__ostream_type", scope: !1105, file: !1101, line: 71, baseType: !1105)
!1186 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1105, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1187 = !DISubprogram(name: "operator<<", linkageName: "_ZNSolsEj", scope: !1105, file: !1101, line: 192, type: !1182, scopeLine: 192, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1188 = !{!1189, !1191}
!1189 = !DILocalVariable(name: "this", arg: 1, scope: !1181, type: !1190, flags: DIFlagArtificial | DIFlagObjectPointer)
!1190 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1105, size: 64)
!1191 = !DILocalVariable(name: "__n", arg: 2, scope: !1181, file: !1101, line: 192, type: !7)
!1192 = !DILocation(line: 0, scope: !1181)
!1193 = !DILocation(line: 192, column: 31, scope: !1181)
!1194 = !DILocation(line: 196, column: 46, scope: !1181)
!1195 = !DILocation(line: 196, column: 9, scope: !1181)
!1196 = !DILocation(line: 196, column: 2, scope: !1181)
!1197 = distinct !DISubprogram(name: "setstate", linkageName: "_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate", scope: !1199, file: !1198, line: 157, type: !1201, scopeLine: 158, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, declaration: !1205, retainedNodes: !1206)
!1198 = !DIFile(filename: "/usr/lib64/gcc/x86_64-pc-linux-gnu/10.2.0/../../../../include/c++/10.2.0/bits/basic_ios.h", directory: "")
!1199 = !DICompositeType(tag: DW_TAG_class_type, name: "basic_ios<char, std::char_traits<char> >", scope: !13, file: !1200, line: 178, flags: DIFlagFwdDecl)
!1200 = !DIFile(filename: "/usr/lib64/gcc/x86_64-pc-linux-gnu/10.2.0/../../../../include/c++/10.2.0/bits/basic_ios.tcc", directory: "")
!1201 = !DISubroutineType(types: !1202)
!1202 = !{null, !1203, !1204}
!1203 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1199, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1204 = !DIDerivedType(tag: DW_TAG_typedef, name: "iostate", scope: !45, file: !12, line: 398, baseType: !11)
!1205 = !DISubprogram(name: "setstate", linkageName: "_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate", scope: !1199, file: !1198, line: 157, type: !1201, scopeLine: 157, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1206 = !{!1207, !1209}
!1207 = !DILocalVariable(name: "this", arg: 1, scope: !1197, type: !1208, flags: DIFlagArtificial | DIFlagObjectPointer)
!1208 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1199, size: 64)
!1209 = !DILocalVariable(name: "__state", arg: 2, scope: !1197, file: !1198, line: 157, type: !1204)
!1210 = !DILocation(line: 0, scope: !1197)
!1211 = !{!1212, !1212, i64 0}
!1212 = !{!"_ZTSSt12_Ios_Iostate", !1026, i64 0}
!1213 = !DILocation(line: 157, column: 24, scope: !1197)
!1214 = !DILocation(line: 158, column: 27, scope: !1197)
!1215 = !DILocation(line: 158, column: 39, scope: !1197)
!1216 = !DILocation(line: 158, column: 37, scope: !1197)
!1217 = !DILocation(line: 158, column: 15, scope: !1197)
!1218 = !DILocation(line: 158, column: 49, scope: !1197)
!1219 = distinct !DISubprogram(name: "length", linkageName: "_ZNSt11char_traitsIcE6lengthEPKc", scope: !1112, file: !1113, line: 351, type: !1132, scopeLine: 352, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, declaration: !1131, retainedNodes: !1220)
!1220 = !{!1221}
!1221 = !DILocalVariable(name: "__s", arg: 1, scope: !1219, file: !1113, line: 351, type: !1129)
!1222 = !DILocation(line: 351, column: 31, scope: !1219)
!1223 = !DILocation(line: 357, column: 26, scope: !1219)
!1224 = !DILocation(line: 357, column: 9, scope: !1219)
!1225 = !DILocation(line: 357, column: 2, scope: !1219)
!1226 = distinct !DISubprogram(name: "operator|", linkageName: "_ZStorSt12_Ios_IostateS_", scope: !13, file: !12, line: 169, type: !1227, scopeLine: 170, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !1229)
!1227 = !DISubroutineType(types: !1228)
!1228 = !{!11, !11, !11}
!1229 = !{!1230, !1231}
!1230 = !DILocalVariable(name: "__a", arg: 1, scope: !1226, file: !12, line: 169, type: !11)
!1231 = !DILocalVariable(name: "__b", arg: 2, scope: !1226, file: !12, line: 169, type: !11)
!1232 = !DILocation(line: 169, column: 26, scope: !1226)
!1233 = !DILocation(line: 169, column: 44, scope: !1226)
!1234 = !DILocation(line: 170, column: 42, scope: !1226)
!1235 = !DILocation(line: 170, column: 66, scope: !1226)
!1236 = !DILocation(line: 170, column: 47, scope: !1226)
!1237 = !DILocation(line: 170, column: 5, scope: !1226)
!1238 = distinct !DISubprogram(name: "rdstate", linkageName: "_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv", scope: !1199, file: !1198, line: 137, type: !1239, scopeLine: 138, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, declaration: !1243, retainedNodes: !1244)
...
!1243 = !DISubprogram(name: "rdstate", linkageName: "_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv", scope: !1199, file: !1198, line: 137, type: !1239, scopeLine: 137, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1244 = !{!1245}
!1245 = !DILocalVariable(name: "this", arg: 1, scope: !1238, type: !1246, flags: DIFlagArtificial | DIFlagObjectPointer)
!1246 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1242, size: 64)
!1247 = !DILocation(line: 0, scope: !1238)
!1248 = !DILocation(line: 138, column: 16, scope: !1238)
!1249 = !{!1250, !1212, i64 32}
!1250 = !{!"_ZTSSt8ios_base", !1042, i64 8, !1042, i64 16, !1251, i64 24, !1212, i64 28, !1212, i64 32, !1030, i64 40, !1252, i64 48, !1026, i64 64, !1025, i64 192, !1030, i64 200, !1253, i64 208}
!1251 = !{!"_ZTSSt13_Ios_Fmtflags", !1026, i64 0}
!1252 = !{!"_ZTSNSt8ios_base6_WordsE", !1030, i64 0, !1042, i64 8}
!1253 = !{!"_ZTSSt6locale", !1030, i64 0}
!1254 = !DILocation(line: 138, column: 9, scope: !1238)
!1255 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_pthread_spinlock_no.cpp", scope: !3, file: !3, type: !1256, flags: DIFlagArtificial | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !29)
!1256 = !DISubroutineType(types: !29)
