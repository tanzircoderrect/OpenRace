; ModuleID = 'integration/dataracebench/DRB063-outeronly1-orig-no.c'
source_filename = "integration/dataracebench/DRB063-outeronly1-orig-no.c"
...
@1 = private unnamed_addr constant [66 x i8] c";integration/dataracebench/DRB063-outeronly1-orig-no.c;foo;57;1;;\00", align 1
@m = dso_local global i32 100, align 4, !dbg !12
@b = common dso_local global [100 x [100 x double]] zeroinitializer, align 16, !dbg !6
@2 = private unnamed_addr constant [67 x i8] c";integration/dataracebench/DRB063-outeronly1-orig-no.c;foo;57;36;;\00", align 1
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  store i32 0, i32* %j, align 4, !dbg !61, !tbaa !58
  br label %for.cond, !dbg !63

for.cond:                                         ; preds = %for.inc, %omp.inner.for.body
  %28 = load i32, i32* %j, align 4, !dbg !64, !tbaa !58
  %29 = load i32, i32* @m, align 4, !dbg !66, !tbaa !58
  %sub8 = sub nsw i32 %29, 1, !dbg !67
  %cmp9 = icmp slt i32 %28, %sub8, !dbg !68
  br i1 %cmp9, label %for.body, label %for.end, !dbg !69

for.body:                                         ; preds = %for.cond
  %30 = load i32, i32* %i4, align 4, !dbg !70, !tbaa !58
  %idxprom = sext i32 %30 to i64, !dbg !71
  %arrayidx = getelementptr inbounds [100 x [100 x double]], [100 x [100 x double]]* @b, i64 0, i64 %idxprom, !dbg !71
  %31 = load i32, i32* %j, align 4, !dbg !72, !tbaa !58
  %add10 = add nsw i32 %31, 1, !dbg !73
  %idxprom11 = sext i32 %add10 to i64, !dbg !71
  %arrayidx12 = getelementptr inbounds [100 x double], [100 x double]* %arrayidx, i64 0, i64 %idxprom11, !dbg !71
  %32 = load double, double* %arrayidx12, align 8, !dbg !71, !tbaa !74
  %33 = load i32, i32* %i4, align 4, !dbg !76, !tbaa !58
  %idxprom13 = sext i32 %33 to i64, !dbg !77
  %arrayidx14 = getelementptr inbounds [100 x [100 x double]], [100 x [100 x double]]* @b, i64 0, i64 %idxprom13, !dbg !77
  %34 = load i32, i32* %j, align 4, !dbg !78, !tbaa !58
  %idxprom15 = sext i32 %34 to i64, !dbg !77
  %arrayidx16 = getelementptr inbounds [100 x double], [100 x double]* %arrayidx14, i64 0, i64 %idxprom15, !dbg !77
  store double %32, double* %arrayidx16, align 8, !dbg !79, !tbaa !74
  br label %for.inc, !dbg !77

for.inc:                                          ; preds = %for.body
  %35 = load i32, i32* %j, align 4, !dbg !80, !tbaa !58
  %inc = add nsw i32 %35, 1, !dbg !80
  store i32 %inc, i32* %j, align 4, !dbg !80, !tbaa !58
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  ...
  %add17 = add nsw i32 %36, 1, !dbg !56
  store i32 %add17, i32* %.omp.iv, align 4, !dbg !56, !tbaa !58
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  %37 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !84
  store i8* getelementptr inbounds ([67 x i8], [67 x i8]* @2, i32 0, i32 0), i8** %37, align 8, !dbg !84, !tbaa !29
  %38 = load i32*, i32** %.global_tid..addr, align 8, !dbg !84
  %39 = load i32, i32* %38, align 4, !dbg !84, !tbaa !58
  call void @__kmpc_for_static_fini(%struct.ident_t* %.kmpc_loc.addr, i32 %39), !dbg !84
  %40 = bitcast i32* %i4 to i8*, !dbg !84
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %40) #4, !dbg !84
  %41 = bitcast i32* %j to i8*, !dbg !84
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %41) #4, !dbg !84
  %42 = bitcast i32* %.omp.is_last to i8*, !dbg !84
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %42) #4, !dbg !84
  %43 = bitcast i32* %.omp.stride to i8*, !dbg !84
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %43) #4, !dbg !84
  %44 = bitcast i32* %.omp.ub to i8*, !dbg !84
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %44) #4, !dbg !84
  %45 = bitcast i32* %.omp.lb to i8*, !dbg !84
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %45) #4, !dbg !84
  br label %omp.precond.end, !dbg !84

omp.precond.end:                                  ; preds = %omp.loop.exit, %entry
  %46 = bitcast i32* %.capture_expr.1 to i8*, !dbg !84
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %46) #4, !dbg !84
  %47 = bitcast i32* %.capture_expr. to i8*, !dbg !84
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %47) #4, !dbg !84
  %48 = bitcast i32* %.omp.iv to i8*, !dbg !84
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %48) #4, !dbg !84
  ret void, !dbg !87
}
...
entry:
  ...
  %0 = load i32*, i32** %.global_tid..addr, align 8, !dbg !93, !tbaa !54
  %1 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !93, !tbaa !54
...
!1 = distinct !DIGlobalVariable(name: "n", scope: !2, file: !3, line: 51, type: !14, isLocal: false, isDefinition: true)
...
!3 = !DIFile(filename: "integration/dataracebench/DRB063-outeronly1-orig-no.c", directory: "/home/brad/Code/OpenRace/tests/data")
!4 = !{}
!5 = !{!6, !0, !12}
!6 = !DIGlobalVariableExpression(var: !7, expr: !DIExpression())
!7 = distinct !DIGlobalVariable(name: "b", scope: !2, file: !3, line: 52, type: !8, isLocal: false, isDefinition: true)
!8 = !DICompositeType(tag: DW_TAG_array_type, baseType: !9, size: 640000, elements: !10)
!9 = !DIBasicType(name: "double", size: 64, encoding: DW_ATE_float)
!10 = !{!11, !11}
!11 = !DISubrange(count: 100)
!12 = !DIGlobalVariableExpression(var: !13, expr: !DIExpression())
!13 = distinct !DIGlobalVariable(name: "m", scope: !2, file: !3, line: 51, type: !14, isLocal: false, isDefinition: true)
!14 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!15 = !{i32 7, !"Dwarf Version", i32 4}
!16 = !{i32 2, !"Debug Info Version", i32 3}
!17 = !{i32 1, !"wchar_size", i32 4}
!18 = !{!"clang version 10.0.1 "}
!19 = distinct !DISubprogram(name: "foo", scope: !3, file: !3, line: 54, type: !20, scopeLine: 55, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !22)
!20 = !DISubroutineType(types: !21)
!21 = !{null}
!22 = !{!23, !24}
!23 = !DILocalVariable(name: "i", scope: !19, file: !3, line: 56, type: !14)
!24 = !DILocalVariable(name: "j", scope: !19, file: !3, line: 56, type: !14)
!25 = !DILocation(line: 56, column: 3, scope: !19)
!26 = !DILocation(line: 56, column: 7, scope: !19)
!27 = !DILocation(line: 56, column: 9, scope: !19)
!28 = !DILocation(line: 57, column: 1, scope: !19)
!29 = !{!30, !34, i64 16}
...
!35 = !DILocation(line: 61, column: 1, scope: !19)
!36 = distinct !DISubprogram(name: ".omp_outlined._debug__", scope: !3, file: !3, line: 58, type: !37, scopeLine: 58, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !43)
...
!56 = !DILocation(line: 58, column: 3, scope: !36)
!57 = !DILocation(line: 58, column: 14, scope: !36)
!58 = !{!31, !31, i64 0}
!59 = !DILocation(line: 58, column: 16, scope: !36)
!60 = !DILocation(line: 58, column: 8, scope: !36)
!61 = !DILocation(line: 59, column: 11, scope: !62)
!62 = distinct !DILexicalBlock(scope: !36, file: !3, line: 59, column: 5)
!63 = !DILocation(line: 59, column: 10, scope: !62)
!64 = !DILocation(line: 59, column: 14, scope: !65)
!65 = distinct !DILexicalBlock(scope: !62, file: !3, line: 59, column: 5)
!66 = !DILocation(line: 59, column: 16, scope: !65)
!67 = !DILocation(line: 59, column: 17, scope: !65)
!68 = !DILocation(line: 59, column: 15, scope: !65)
!69 = !DILocation(line: 59, column: 5, scope: !62)
!70 = !DILocation(line: 60, column: 17, scope: !65)
!71 = !DILocation(line: 60, column: 15, scope: !65)
!72 = !DILocation(line: 60, column: 20, scope: !65)
!73 = !DILocation(line: 60, column: 21, scope: !65)
!74 = !{!75, !75, i64 0}
!75 = !{!"double", !32, i64 0}
!76 = !DILocation(line: 60, column: 9, scope: !65)
!77 = !DILocation(line: 60, column: 7, scope: !65)
!78 = !DILocation(line: 60, column: 12, scope: !65)
!79 = !DILocation(line: 60, column: 14, scope: !65)
!80 = !DILocation(line: 59, column: 21, scope: !65)
!81 = !DILocation(line: 59, column: 5, scope: !65)
!82 = distinct !{!82, !69, !83}
!83 = !DILocation(line: 60, column: 23, scope: !62)
!84 = !DILocation(line: 57, column: 1, scope: !36)
!85 = distinct !{!85, !84, !86}
!86 = !DILocation(line: 57, column: 36, scope: !36)
!87 = !DILocation(line: 60, column: 23, scope: !36)
!88 = distinct !DISubprogram(name: ".omp_outlined.", scope: !3, file: !3, line: 58, type: !37, scopeLine: 58, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !89)
!89 = !{!90, !91}
!90 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !88, type: !39, flags: DIFlagArtificial)
!91 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !88, type: !39, flags: DIFlagArtificial)
!92 = !DILocation(line: 0, scope: !88)
!93 = !DILocation(line: 58, column: 3, scope: !88)
!94 = !{!95}
!95 = !{i64 2, i64 -1, i64 -1, i1 true}
!96 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 63, type: !97, scopeLine: 64, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !4)
!97 = !DISubroutineType(types: !98)
!98 = !{!14}
!99 = !DILocation(line: 65, column: 3, scope: !96)
!100 = !DILocation(line: 66, column: 3, scope: !96)
