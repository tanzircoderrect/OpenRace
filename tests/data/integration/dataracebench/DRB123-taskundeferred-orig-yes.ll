; ModuleID = 'integration/dataracebench/DRB123-taskundeferred-orig-yes.c'
source_filename = "integration/dataracebench/DRB123-taskundeferred-orig-yes.c"
...
@1 = private unnamed_addr constant [72 x i8] c";integration/dataracebench/DRB123-taskundeferred-orig-yes.c;main;25;3;;\00", align 1
@2 = private unnamed_addr constant [72 x i8] c";integration/dataracebench/DRB123-taskundeferred-orig-yes.c;main;28;7;;\00", align 1
@3 = private unnamed_addr constant [73 x i8] c";integration/dataracebench/DRB123-taskundeferred-orig-yes.c;main;25;32;;\00", align 1
...
entry:
  ...
  store i8* getelementptr inbounds ([72 x i8], [72 x i8]* @1, i32 0, i32 0), i8** %4, align 8, !dbg !31, !tbaa !32
  ...
  %cmp = icmp ne i32 %5, 10, !dbg !36
  br i1 %cmp, label %if.then, label %if.end, !dbg !37

if.then:                                          ; preds = %entry
  %6 = load i32, i32* %var, align 4, !dbg !38, !tbaa !19
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32 %6), !dbg !39
  br label %if.end, !dbg !39

if.end:                                           ; preds = %if.then, %entry
  %7 = bitcast i32* %i to i8*, !dbg !40
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %7) #6, !dbg !40
  %8 = bitcast i32* %var to i8*, !dbg !40
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %8) #6, !dbg !40
  ret i32 0, !dbg !41
}
...
define internal void @.omp_outlined._debug__(i32* noalias %.global_tid., i32* noalias %.bound_tid., i32* dereferenceable(4) %i, i32* dereferenceable(4) %var) #3 !dbg !42 {
entry:
  ...
  %2 = load i32*, i32** %i.addr, align 8, !dbg !58, !tbaa !24
  %3 = load i32*, i32** %var.addr, align 8, !dbg !58, !tbaa !24
  store i32 0, i32* %.omp.sections.lb., align 4, !dbg !58, !tbaa !19
  store i32 0, i32* %.omp.sections.ub., align 4, !dbg !58, !tbaa !19
  store i32 1, i32* %.omp.sections.st., align 4, !dbg !58, !tbaa !19
  store i32 0, i32* %.omp.sections.il., align 4, !dbg !58, !tbaa !19
  %4 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !58
  store i8* getelementptr inbounds ([72 x i8], [72 x i8]* @1, i32 0, i32 0), i8** %4, align 8, !dbg !58, !tbaa !32
  %5 = load i32*, i32** %.global_tid..addr, align 8, !dbg !58
  %6 = load i32, i32* %5, align 4, !dbg !58, !tbaa !19
  call void @__kmpc_for_static_init_4(%struct.ident_t* %.kmpc_loc.addr, i32 %6, i32 34, i32* %.omp.sections.il., i32* %.omp.sections.lb., i32* %.omp.sections.ub., i32* %.omp.sections.st., i32 1, i32 1), !dbg !58
  %7 = load i32, i32* %.omp.sections.ub., align 4, !dbg !58, !tbaa !19
  %8 = icmp slt i32 %7, 0, !dbg !58
  %9 = select i1 %8, i32 %7, i32 0, !dbg !58
  store i32 %9, i32* %.omp.sections.ub., align 4, !dbg !58, !tbaa !19
  %10 = load i32, i32* %.omp.sections.lb., align 4, !dbg !58, !tbaa !19
  store i32 %10, i32* %.omp.sections.iv., align 4, !dbg !58, !tbaa !19
  br label %omp.inner.for.cond, !dbg !58

omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %entry
  %11 = load i32, i32* %.omp.sections.iv., align 4, !dbg !59, !tbaa !19
  %12 = load i32, i32* %.omp.sections.ub., align 4, !dbg !59, !tbaa !19
  %cmp = icmp sle i32 %11, %12, !dbg !59
  br i1 %cmp, label %omp.inner.for.body, label %omp.inner.for.end, !dbg !58

omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %13 = load i32, i32* %.omp.sections.iv., align 4, !dbg !58, !tbaa !19
  switch i32 %13, label %.omp.sections.exit [
    i32 0, label %.omp.sections.case
  ], !dbg !58

.omp.sections.case:                               ; preds = %omp.inner.for.body
  store i32 0, i32* %2, align 4, !dbg !60, !tbaa !19
  br label %for.cond, !dbg !62

for.cond:                                         ; preds = %for.inc, %.omp.sections.case
  %14 = load i32, i32* %2, align 4, !dbg !63, !tbaa !19
  %cmp1 = icmp slt i32 %14, 10, !dbg !65
  br i1 %cmp1, label %for.body, label %for.end, !dbg !66

for.body:                                         ; preds = %for.cond
  %15 = getelementptr inbounds %struct.anon, %struct.anon* %agg.captured, i32 0, i32 0, !dbg !67
  store i32* %3, i32** %15, align 8, !dbg !67, !tbaa !24
  %16 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !67
  store i8* getelementptr inbounds ([72 x i8], [72 x i8]* @2, i32 0, i32 0), i8** %16, align 8, !dbg !67, !tbaa !32
  %17 = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* %.kmpc_loc.addr, i32 %6, i32 1, i64 40, i64 8, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates*)* @.omp_task_entry. to i32 (i32, i8*)*)), !dbg !67
  %18 = bitcast i8* %17 to %struct.kmp_task_t_with_privates*, !dbg !67
  %19 = getelementptr inbounds %struct.kmp_task_t_with_privates, %struct.kmp_task_t_with_privates* %18, i32 0, i32 0, !dbg !67
  %20 = getelementptr inbounds %struct.kmp_task_t, %struct.kmp_task_t* %19, i32 0, i32 0, !dbg !67
  %21 = load i8*, i8** %20, align 8, !dbg !67, !tbaa !69
  %22 = bitcast %struct.anon* %agg.captured to i8*, !dbg !67
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %21, i8* align 8 %22, i64 8, i1 false), !dbg !67, !tbaa.struct !72
  %23 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !67
  store i8* getelementptr inbounds ([72 x i8], [72 x i8]* @2, i32 0, i32 0), i8** %23, align 8, !dbg !67, !tbaa !32
  %24 = call i32 @__kmpc_omp_task(%struct.ident_t* %.kmpc_loc.addr, i32 %6, i8* %17), !dbg !67
...
omp.inner.for.inc:                                ; preds = %.omp.sections.exit
  %26 = load i32, i32* %.omp.sections.iv., align 4, !dbg !59, !tbaa !19
  %inc2 = add nsw i32 %26, 1, !dbg !59
  store i32 %inc2, i32* %.omp.sections.iv., align 4, !dbg !59, !tbaa !19
...
omp.inner.for.end:                                ; preds = %omp.inner.for.cond
  ...
  store i8* getelementptr inbounds ([73 x i8], [73 x i8]* @3, i32 0, i32 0), i8** %27, align 8, !dbg !77, !tbaa !32
...
entry:
  ...
  %7 = load i8*, i8** %6, align 8, !dbg !128, !tbaa !69
...
!1 = !DIFile(filename: "integration/dataracebench/DRB123-taskundeferred-orig-yes.c", directory: "/home/brad/Code/OpenRace/tests/data")
!2 = !{}
...
!35 = distinct !DILexicalBlock(scope: !7, file: !1, line: 35, column: 7)
!36 = !DILocation(line: 35, column: 10, scope: !35)
!37 = !DILocation(line: 35, column: 7, scope: !7)
...
!71 = !{!"kmp_task_t", !25, i64 0, !25, i64 8, !20, i64 16, !21, i64 24, !21, i64 32}
!72 = !{i64 0, i64 8, !24}
...
!79 = !DILocation(line: 25, column: 32, scope: !42)
!80 = !DILocation(line: 33, column: 3, scope: !42)
...
!96 = distinct !DICompositeType(tag: DW_TAG_structure_type, scope: !42, file: !1, line: 28, size: 64, elements: !2)
!97 = !{!98, !99, !100, !101, !102, !103}
!98 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !81, type: !48, flags: DIFlagArtificial)
!99 = !DILocalVariable(name: ".part_id.", arg: 2, scope: !81, type: !45, flags: DIFlagArtificial)
...
!129 = distinct !DISubprogram(name: ".omp_outlined..1", scope: !1, file: !1, line: 26, type: !43, scopeLine: 26, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !130)
!130 = !{!131, !132, !133, !134}
!131 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !129, type: !45, flags: DIFlagArtificial)
!132 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !129, type: !45, flags: DIFlagArtificial)
!133 = !DILocalVariable(name: "i", arg: 3, scope: !129, type: !49, flags: DIFlagArtificial)
!134 = !DILocalVariable(name: "var", arg: 4, scope: !129, type: !49, flags: DIFlagArtificial)
