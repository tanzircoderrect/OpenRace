...
entry:
  ...
  store i8* getelementptr inbounds ([51 x i8], [51 x i8]* @1, i32 0, i32 0), i8** %2, align 8, !tbaa !20
  ...
  store i8* getelementptr inbounds ([51 x i8], [51 x i8]* @1, i32 0, i32 0), i8** %6, align 8, !dbg !28, !tbaa !20
  ...
  store i8* getelementptr inbounds ([51 x i8], [51 x i8]* @1, i32 0, i32 0), i8** %19, align 8, !dbg !28, !tbaa !20
...
entry:
  ...
  store i8* getelementptr inbounds ([47 x i8], [47 x i8]* @3, i32 0, i32 0), i8** %3, align 8, !dbg !110, !tbaa !20
...
entry:
  ...
  store i8* getelementptr inbounds ([47 x i8], [47 x i8]* @2, i32 0, i32 0), i8** %3, align 8, !dbg !151, !tbaa !20
...
omp_if.end:                                       ; preds = %for.end, %entry
  ...
  store i8* getelementptr inbounds ([47 x i8], [47 x i8]* @2, i32 0, i32 0), i8** %13, align 8, !dbg !171, !tbaa !20
...
!2 = distinct !DICompileUnit(language: DW_LANG_C_plus_plus_14, file: !3, producer: "clang version 10.0.0-4ubuntu1 ", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !4, globals: !5, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "DRB100-task-reference-orig-no.cpp", directory: "/home/tanzir/OpenRace/tests/data/integration/dataracebench")
!4 = !{}
!5 = !{!0}
