...
@1 = private unnamed_addr constant [61 x i8] c";DRB144-critical-missingreduction-orig-gpu-yes.c;main;23;3;;\00", align 1
...
@4 = private unnamed_addr constant [62 x i8] c";DRB144-critical-missingreduction-orig-gpu-yes.c;main;23;44;;\00", align 1
...
entry:
  ...
  call void @__omp_offloading_10307_2ec41a9_main_l22(i32* @var) #5, !dbg !14
  %0 = load i32, i32* @var, align 4, !dbg !16
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 %0), !dbg !17
  ret i32 0, !dbg !18
}

; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @__omp_offloading_10307_2ec41a9_main_l22_debug__(i32* dereferenceable(4) %var) #1 !dbg !19 {
entry:
  ...
  store i8* getelementptr inbounds ([61 x i8], [61 x i8]* @1, i32 0, i32 0), i8** %3, align 8, !dbg !25
...
entry:
  ...
  store i32 199, i32* %.omp.comb.ub, align 4, !dbg !42
  ...
  store i8* getelementptr inbounds ([61 x i8], [61 x i8]* @1, i32 0, i32 0), i8** %3, align 8, !dbg !39
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ 199, %cond.true ], [ %7, %cond.false ], !dbg !42
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  store i8* getelementptr inbounds ([61 x i8], [61 x i8]* @1, i32 0, i32 0), i8** %15, align 8, !dbg !47
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  store i8* getelementptr inbounds ([61 x i8], [61 x i8]* @1, i32 0, i32 0), i8** %18, align 8, !dbg !48
...
entry:
  ...
  store i32 199, i32* %.omp.ub, align 4, !dbg !68
  ...
  store i8* getelementptr inbounds ([61 x i8], [61 x i8]* @1, i32 0, i32 0), i8** %5, align 8, !dbg !65
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ 199, %cond.true ], [ %9, %cond.false ], !dbg !68
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  store i8* getelementptr inbounds ([61 x i8], [61 x i8]* @3, i32 0, i32 0), i8** %14, align 8, !dbg !74
  call void @__kmpc_critical(%struct.ident_t* %.kmpc_loc.addr, i32 %7, [8 x i32]* @.gomp_critical_user_.var), !dbg !74
  %15 = load i32, i32* %2, align 4, !dbg !76
  %inc = add nsw i32 %15, 1, !dbg !76
  store i32 %inc, i32* %2, align 4, !dbg !76
  call void @__kmpc_end_critical(%struct.ident_t* %.kmpc_loc.addr, i32 %7, [8 x i32]* @.gomp_critical_user_.var), !dbg !78
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %16 = load i32, i32* %.omp.iv, align 4, !dbg !68
  %add5 = add nsw i32 %16, 1, !dbg !65
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  %17 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !80
  store i8* getelementptr inbounds ([62 x i8], [62 x i8]* @4, i32 0, i32 0), i8** %17, align 8, !dbg !80
  call void @__kmpc_for_static_fini(%struct.ident_t* %.kmpc_loc.addr, i32 %7), !dbg !80
  ret void, !dbg !83
}
...
; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid., i64 %.previous.lb., i64 %.previous.ub., i32* dereferenceable(4) %var) #1 !dbg !84 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %.previous.lb..addr = alloca i64, align 8
  ...
  %var.addr = alloca i32*, align 8
  store i32* %.global_tid., i32** %.global_tid..addr, align 8
  call void @llvm.dbg.declare(metadata i32** %.global_tid..addr, metadata !85, metadata !DIExpression()), !dbg !86
  store i32* %.bound_tid., i32** %.bound_tid..addr, align 8
  call void @llvm.dbg.declare(metadata i32** %.bound_tid..addr, metadata !87, metadata !DIExpression()), !dbg !86
  store i64 %.previous.lb., i64* %.previous.lb..addr, align 8
  call void @llvm.dbg.declare(metadata i64* %.previous.lb..addr, metadata !88, metadata !DIExpression()), !dbg !86
  store i64 %.previous.ub., i64* %.previous.ub..addr, align 8
  call void @llvm.dbg.declare(metadata i64* %.previous.ub..addr, metadata !89, metadata !DIExpression()), !dbg !86
  store i32* %var, i32** %var.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %var.addr, metadata !90, metadata !DIExpression()), !dbg !86
  %0 = load i32*, i32** %var.addr, align 8, !dbg !91
  %1 = load i32*, i32** %.global_tid..addr, align 8, !dbg !91
  %2 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !91
  %3 = load i64, i64* %.previous.lb..addr, align 8, !dbg !91
  %4 = load i64, i64* %.previous.ub..addr, align 8, !dbg !91
  %5 = load i32*, i32** %var.addr, align 8, !dbg !91
  call void @.omp_outlined._debug__.1(i32* %1, i32* %2, i64 %3, i64 %4, i32* %5) #5, !dbg !91
  ret void, !dbg !91
}
...
; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @.omp_outlined..2(i32* noalias %.global_tid., i32* noalias %.bound_tid., i32* dereferenceable(4) %var) #1 !dbg !94 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %var.addr = alloca i32*, align 8
  ...
  store i32* %var, i32** %var.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %var.addr, metadata !98, metadata !DIExpression()), !dbg !96
  %0 = load i32*, i32** %var.addr, align 8, !dbg !99
  %1 = load i32*, i32** %.global_tid..addr, align 8, !dbg !99
  %2 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !99
  %3 = load i32*, i32** %var.addr, align 8, !dbg !99
  call void @.omp_outlined._debug__(i32* %1, i32* %2, i32* %3) #5, !dbg !99
  ret void, !dbg !99
}

declare !callback !92 dso_local void @__kmpc_fork_teams(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...)

; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @__omp_offloading_10307_2ec41a9_main_l22(i32* dereferenceable(4) %var) #1 !dbg !100 {
entry:
  %var.addr = alloca i32*, align 8
  store i32* %var, i32** %var.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %var.addr, metadata !101, metadata !DIExpression()), !dbg !102
  %0 = load i32*, i32** %var.addr, align 8, !dbg !103
  %1 = load i32*, i32** %var.addr, align 8, !dbg !103
  call void @__omp_offloading_10307_2ec41a9_main_l22_debug__(i32* %1) #5, !dbg !103
  ret void, !dbg !103
}
...
!3 = !DIFile(filename: "DRB144-critical-missingreduction-orig-gpu-yes.c", directory: "/home/yanze/code/OpenRace/tests/data/integration/dataracebench")
!4 = !{}
!5 = !{!0}
...
!16 = !DILocation(line: 29, column: 18, scope: !11)
!17 = !DILocation(line: 29, column: 3, scope: !11)
!18 = !DILocation(line: 31, column: 3, scope: !11)
!19 = distinct !DISubprogram(name: "__omp_offloading_10307_2ec41a9_main_l22_debug__", scope: !3, file: !3, line: 23, type: !20, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!26 = !DILocation(line: 23, column: 44, scope: !19)
...
!42 = !DILocation(line: 24, column: 7, scope: !27)
...
!48 = !DILocation(line: 23, column: 44, scope: !49)
!49 = distinct !DILexicalBlock(scope: !27, file: !3, line: 23, column: 3)
!50 = distinct !{!50, !47, !51}
!51 = !DILocation(line: 23, column: 44, scope: !27)
!52 = !DILocation(line: 27, column: 3, scope: !27)
!53 = distinct !DISubprogram(name: ".omp_outlined._debug__.1", scope: !3, file: !3, line: 24, type: !54, scopeLine: 24, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!63 = !DILocalVariable(name: "var", arg: 5, scope: !53, file: !3, line: 19, type: !22)
!64 = !DILocation(line: 19, column: 5, scope: !53)
!65 = !DILocation(line: 24, column: 3, scope: !53)
...
!68 = !DILocation(line: 24, column: 7, scope: !53)
...
!73 = !DILocation(line: 24, column: 23, scope: !53)
!74 = !DILocation(line: 25, column: 5, scope: !75)
!75 = distinct !DILexicalBlock(scope: !53, file: !3, line: 24, column: 27)
!76 = !DILocation(line: 26, column: 8, scope: !77)
!77 = distinct !DILexicalBlock(scope: !75, file: !3, line: 25, column: 5)
!78 = !DILocation(line: 26, column: 5, scope: !77)
!79 = !DILocation(line: 27, column: 3, scope: !75)
!80 = !DILocation(line: 23, column: 3, scope: !53)
!81 = distinct !{!81, !80, !82}
!82 = !DILocation(line: 23, column: 44, scope: !53)
!83 = !DILocation(line: 27, column: 3, scope: !53)
!84 = distinct !DISubprogram(name: ".omp_outlined.", scope: !3, file: !3, line: 24, type: !54, scopeLine: 24, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!85 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !84, type: !30, flags: DIFlagArtificial)
!86 = !DILocation(line: 0, scope: !84)
!87 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !84, type: !30, flags: DIFlagArtificial)
!88 = !DILocalVariable(name: ".previous.lb.", arg: 3, scope: !84, type: !56, flags: DIFlagArtificial)
!89 = !DILocalVariable(name: ".previous.ub.", arg: 4, scope: !84, type: !56, flags: DIFlagArtificial)
!90 = !DILocalVariable(name: "var", arg: 5, scope: !84, type: !22, flags: DIFlagArtificial)
!91 = !DILocation(line: 24, column: 3, scope: !84)
!92 = !{!93}
!93 = !{i64 2, i64 -1, i64 -1, i1 true}
!94 = distinct !DISubprogram(name: ".omp_outlined..2", scope: !3, file: !3, line: 24, type: !28, scopeLine: 24, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!95 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !94, type: !30, flags: DIFlagArtificial)
!96 = !DILocation(line: 0, scope: !94)
!97 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !94, type: !30, flags: DIFlagArtificial)
!98 = !DILocalVariable(name: "var", arg: 3, scope: !94, type: !22, flags: DIFlagArtificial)
!99 = !DILocation(line: 24, column: 3, scope: !94)
!100 = distinct !DISubprogram(name: "__omp_offloading_10307_2ec41a9_main_l22", scope: !3, file: !3, line: 23, type: !20, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!101 = !DILocalVariable(name: "var", arg: 1, scope: !100, type: !22, flags: DIFlagArtificial)
!102 = !DILocation(line: 0, scope: !100)
!103 = !DILocation(line: 23, column: 3, scope: !100)
