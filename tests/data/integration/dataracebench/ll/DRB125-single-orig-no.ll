...
@1 = private unnamed_addr constant [37 x i8] c";DRB125-single-orig-no.c;main;31;5;;\00", align 1
@2 = private unnamed_addr constant [37 x i8] c";DRB125-single-orig-no.c;main;29;3;;\00", align 1
...
entry:
  ...
  store i8* getelementptr inbounds ([37 x i8], [37 x i8]* @2, i32 0, i32 0), i8** %2, align 8, !dbg !22
...
entry:
  ...
  store i8* getelementptr inbounds ([37 x i8], [37 x i8]* @1, i32 0, i32 0), i8** %3, align 8, !dbg !39
...
omp_if.then:                                      ; preds = %entry
  ...
  call void @__kmpc_end_single(%struct.ident_t* %.kmpc_loc.addr, i32 %5), !dbg !44
  br label %omp_if.end, !dbg !44

omp_if.end:                                       ; preds = %omp_if.then, %entry
  %8 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !45
  store i8* getelementptr inbounds ([37 x i8], [37 x i8]* @1, i32 0, i32 0), i8** %8, align 8, !dbg !45
  call void @__kmpc_barrier(%struct.ident_t* %.kmpc_loc.addr, i32 %5), !dbg !45
  %9 = load i32, i32* %2, align 4, !dbg !46
  store i32 %9, i32* %local, align 4, !dbg !47
  ret void, !dbg !48
}
...
; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid., i32* dereferenceable(4) %init) #2 !dbg !49 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %init.addr = alloca i32*, align 8
  ...
  store i32* %init, i32** %init.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %init.addr, metadata !53, metadata !DIExpression()), !dbg !51
  %0 = load i32*, i32** %init.addr, align 8, !dbg !54
  %1 = load i32*, i32** %.global_tid..addr, align 8, !dbg !54
  %2 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !54
  %3 = load i32*, i32** %init.addr, align 8, !dbg !54
  call void @.omp_outlined._debug__(i32* %1, i32* %2, i32* %3) #4, !dbg !54
  ret void, !dbg !54
}
...
!1 = !DIFile(filename: "DRB125-single-orig-no.c", directory: "/home/yanze/code/OpenRace/tests/data/integration/dataracebench")
!2 = !{}
...
!41 = !DILocation(line: 33, column: 10, scope: !42)
...
!47 = !DILocation(line: 35, column: 11, scope: !40)
!48 = !DILocation(line: 36, column: 3, scope: !24)
!49 = distinct !DISubprogram(name: ".omp_outlined.", scope: !1, file: !1, line: 30, type: !25, scopeLine: 30, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
!50 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !49, type: !27, flags: DIFlagArtificial)
!51 = !DILocation(line: 0, scope: !49)
!52 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !49, type: !27, flags: DIFlagArtificial)
!53 = !DILocalVariable(name: "init", arg: 3, scope: !49, type: !31, flags: DIFlagArtificial)
!54 = !DILocation(line: 30, column: 3, scope: !49)
!55 = !{!56}
