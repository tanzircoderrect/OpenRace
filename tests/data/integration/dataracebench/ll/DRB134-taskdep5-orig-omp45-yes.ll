...
@1 = private unnamed_addr constant [45 x i8] c";DRB134-taskdep5-orig-omp45-yes.c;foo;24;3;;\00", align 1
@2 = private unnamed_addr constant [45 x i8] c";DRB134-taskdep5-orig-omp45-yes.c;foo;27;3;;\00", align 1
@3 = private unnamed_addr constant [45 x i8] c";DRB134-taskdep5-orig-omp45-yes.c;foo;30;3;;\00", align 1
...
@4 = private unnamed_addr constant [45 x i8] c";DRB134-taskdep5-orig-omp45-yes.c;foo;36;3;;\00", align 1
@5 = private unnamed_addr constant [46 x i8] c";DRB134-taskdep5-orig-omp45-yes.c;main;42;3;;\00", align 1
@6 = private unnamed_addr constant [46 x i8] c";DRB134-taskdep5-orig-omp45-yes.c;main;41;3;;\00", align 1
...
entry:
  ...
  store i8* getelementptr inbounds ([45 x i8], [45 x i8]* @1, i32 0, i32 0), i8** %2, align 8
  ...
  store i8* getelementptr inbounds ([45 x i8], [45 x i8]* @1, i32 0, i32 0), i8** %5, align 8, !dbg !15
  ...
  store i8* getelementptr inbounds ([45 x i8], [45 x i8]* @1, i32 0, i32 0), i8** %19, align 8, !dbg !15
  ...
  store i8* getelementptr inbounds ([45 x i8], [45 x i8]* @2, i32 0, i32 0), i8** %23, align 8, !dbg !16
  ...
  store i8* getelementptr inbounds ([45 x i8], [45 x i8]* @2, i32 0, i32 0), i8** %42, align 8, !dbg !16
  ...
  store i8* getelementptr inbounds ([45 x i8], [45 x i8]* @3, i32 0, i32 0), i8** %44, align 8, !dbg !17
  ...
  store i8* getelementptr inbounds ([45 x i8], [45 x i8]* @3, i32 0, i32 0), i8** %55, align 8, !dbg !17
  ...
  %58 = load i32, i32* %y, align 4, !dbg !24
  %call5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.6, i64 0, i64 0), i32 %58), !dbg !25
  %59 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !26
  store i8* getelementptr inbounds ([45 x i8], [45 x i8]* @4, i32 0, i32 0), i8** %59, align 8, !dbg !26
  %60 = call i32 @__kmpc_omp_taskwait(%struct.ident_t* %.kmpc_loc.addr, i32 %3), !dbg !26
  ret void, !dbg !27
}
...
entry:
  ...
  %11 = getelementptr inbounds %struct.anon.0, %struct.anon.0* %10, i32 0, i32 1, !dbg !112
  %12 = load i32*, i32** %11, align 8, !dbg !112
  %13 = load i32, i32* %12, align 4, !dbg !112
  %14 = getelementptr inbounds %struct.anon.0, %struct.anon.0* %10, i32 0, i32 0, !dbg !111
  %15 = load i32*, i32** %14, align 8, !dbg !111
  %16 = load i32, i32* %15, align 4, !dbg !113
  %sub.i = sub nsw i32 %16, %13, !dbg !113
  store i32 %sub.i, i32* %15, align 4, !dbg !113
  ret i32 0, !dbg !104
}

; Function Attrs: noinline norecurse nounwind uwtable
define internal i32 @.omp_task_entry..4(i32 %0, %struct.kmp_task_t_with_privates.3* noalias %1) #2 !dbg !114 {
entry:
  %.global_tid..addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %.global_tid..addr.i, metadata !115, metadata !DIExpression()), !dbg !123
  %.part_id..addr.i = alloca i32*, align 8
  call void @llvm.dbg.declare(metadata i32** %.part_id..addr.i, metadata !125, metadata !DIExpression()), !dbg !123
  %.privates..addr.i = alloca i8*, align 8
  call void @llvm.dbg.declare(metadata i8** %.privates..addr.i, metadata !126, metadata !DIExpression()), !dbg !123
  %.copy_fn..addr.i = alloca void (i8*, ...)*, align 8
  call void @llvm.dbg.declare(metadata void (i8*, ...)** %.copy_fn..addr.i, metadata !127, metadata !DIExpression()), !dbg !123
  %.task_t..addr.i = alloca i8*, align 8
  call void @llvm.dbg.declare(metadata i8** %.task_t..addr.i, metadata !128, metadata !DIExpression()), !dbg !123
  %__context.addr.i = alloca %struct.anon.2*, align 8
  call void @llvm.dbg.declare(metadata %struct.anon.2** %__context.addr.i, metadata !129, metadata !DIExpression()), !dbg !123
  %.addr = alloca i32, align 4
  %.addr1 = alloca %struct.kmp_task_t_with_privates.3*, align 8
  store i32 %0, i32* %.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %.addr, metadata !130, metadata !DIExpression()), !dbg !131
  store %struct.kmp_task_t_with_privates.3* %1, %struct.kmp_task_t_with_privates.3** %.addr1, align 8
  call void @llvm.dbg.declare(metadata %struct.kmp_task_t_with_privates.3** %.addr1, metadata !132, metadata !DIExpression()), !dbg !131
  %2 = load i32, i32* %.addr, align 4, !dbg !138
  ...
  %7 = load i8*, i8** %6, align 8, !dbg !138
  %8 = bitcast i8* %7 to %struct.anon.2*, !dbg !138
  %9 = bitcast %struct.kmp_task_t_with_privates.3* %3 to i8*, !dbg !138
  store i32 %2, i32* %.global_tid..addr.i, align 4, !noalias !139
  store i32* %5, i32** %.part_id..addr.i, align 8, !noalias !139
  store i8* null, i8** %.privates..addr.i, align 8, !noalias !139
  store void (i8*, ...)* null, void (i8*, ...)** %.copy_fn..addr.i, align 8, !noalias !139
  store i8* %9, i8** %.task_t..addr.i, align 8, !noalias !139
  store %struct.anon.2* %8, %struct.anon.2** %__context.addr.i, align 8, !noalias !139
  %10 = load %struct.anon.2*, %struct.anon.2** %__context.addr.i, align 8, !dbg !145, !noalias !139
  ret i32 0, !dbg !138
}
...
entry:
  ...
  %2 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !149
  store i8* getelementptr inbounds ([46 x i8], [46 x i8]* @6, i32 0, i32 0), i8** %2, align 8, !dbg !149
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* %.kmpc_loc.addr, i32 0, void (i32*, i32*, ...)* bitcast (void (i32*, i32*)* @.omp_outlined..7 to void (i32*, i32*, ...)*)), !dbg !149
  ret i32 0, !dbg !150
}

; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @.omp_outlined._debug__(i32* noalias %.global_tid., i32* noalias %.bound_tid.) #5 !dbg !151 {
entry:
  ...
  %2 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !157
  store i8* getelementptr inbounds ([46 x i8], [46 x i8]* @5, i32 0, i32 0), i8** %2, align 8, !dbg !157
  %3 = load i32*, i32** %.global_tid..addr, align 8, !dbg !157
  %4 = load i32, i32* %3, align 4, !dbg !157
  %5 = call i32 @__kmpc_single(%struct.ident_t* %.kmpc_loc.addr, i32 %4), !dbg !157
  %6 = icmp ne i32 %5, 0, !dbg !157
  br i1 %6, label %omp_if.then, label %omp_if.end, !dbg !157

omp_if.then:                                      ; preds = %entry
  call void @foo(), !dbg !158
  call void @__kmpc_end_single(%struct.ident_t* %.kmpc_loc.addr, i32 %4), !dbg !158
  br label %omp_if.end, !dbg !158

omp_if.end:                                       ; preds = %omp_if.then, %entry
  %7 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !160
  store i8* getelementptr inbounds ([46 x i8], [46 x i8]* @5, i32 0, i32 0), i8** %7, align 8, !dbg !160
  call void @__kmpc_barrier(%struct.ident_t* %.kmpc_loc.addr, i32 %4), !dbg !160
  ret void, !dbg !161
}
...
; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @.omp_outlined..7(i32* noalias %.global_tid., i32* noalias %.bound_tid.) #5 !dbg !162 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  store i32* %.global_tid., i32** %.global_tid..addr, align 8
  ...
  %0 = load i32*, i32** %.global_tid..addr, align 8, !dbg !166
  %1 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !166
  call void @.omp_outlined._debug__(i32* %0, i32* %1) #6, !dbg !166
  ret void, !dbg !166
}

declare !callback !167 dso_local void @__kmpc_fork_call(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...)
...
!1 = !DIFile(filename: "DRB134-taskdep5-orig-omp45-yes.c", directory: "/home/yanze/code/OpenRace/tests/data/integration/dataracebench")
!2 = !{}
...
!25 = !DILocation(line: 34, column: 3, scope: !7)
!26 = !DILocation(line: 36, column: 3, scope: !7)
...
!112 = !DILocation(line: 28, column: 8, scope: !82, inlinedAt: !90)
!113 = !DILocation(line: 28, column: 5, scope: !82, inlinedAt: !90)
!114 = distinct !DISubprogram(linkageName: ".omp_task_entry..4", scope: !1, file: !1, line: 30, type: !29, scopeLine: 30, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
!115 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !116, type: !34, flags: DIFlagArtificial)
!116 = distinct !DISubprogram(name: ".omp_outlined..3", scope: !1, file: !1, line: 30, type: !117, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
!117 = !DISubroutineType(types: !118)
!118 = !{null, !34, !35, !38, !41, !46, !119}
!119 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !120)
!120 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !121)
!121 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !122, size: 64)
!122 = distinct !DICompositeType(tag: DW_TAG_structure_type, scope: !7, file: !1, line: 30, elements: !2)
!123 = !DILocation(line: 0, scope: !116, inlinedAt: !124)
!124 = distinct !DILocation(line: 30, column: 3, scope: !114)
!125 = !DILocalVariable(name: ".part_id.", arg: 2, scope: !116, type: !35, flags: DIFlagArtificial)
!126 = !DILocalVariable(name: ".privates.", arg: 3, scope: !116, type: !38, flags: DIFlagArtificial)
!127 = !DILocalVariable(name: ".copy_fn.", arg: 4, scope: !116, type: !41, flags: DIFlagArtificial)
!128 = !DILocalVariable(name: ".task_t.", arg: 5, scope: !116, type: !46, flags: DIFlagArtificial)
!129 = !DILocalVariable(name: "__context", arg: 6, scope: !116, type: !119, flags: DIFlagArtificial)
!130 = !DILocalVariable(arg: 1, scope: !114, type: !11, flags: DIFlagArtificial)
!131 = !DILocation(line: 0, scope: !114)
!132 = !DILocalVariable(arg: 2, scope: !114, type: !133, flags: DIFlagArtificial)
!133 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !134)
!134 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !135, size: 64)
!135 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "kmp_task_t_with_privates", file: !1, size: 320, elements: !136)
!136 = !{!137}
!137 = !DIDerivedType(tag: DW_TAG_member, scope: !135, file: !1, baseType: !66, size: 320)
!138 = !DILocation(line: 30, column: 3, scope: !114)
!139 = !{!140, !142, !143, !144}
!140 = distinct !{!140, !141, !".omp_outlined..3: %.part_id."}
!141 = distinct !{!141, !".omp_outlined..3"}
!142 = distinct !{!142, !141, !".omp_outlined..3: %.privates."}
!143 = distinct !{!143, !141, !".omp_outlined..3: %.copy_fn."}
!144 = distinct !{!144, !141, !".omp_outlined..3: %__context"}
!145 = !DILocation(line: 31, column: 3, scope: !116, inlinedAt: !124)
!146 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 40, type: !147, scopeLine: 40, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!147 = !DISubroutineType(types: !148)
!148 = !{!11}
!149 = !DILocation(line: 41, column: 3, scope: !146)
!150 = !DILocation(line: 45, column: 3, scope: !146)
!151 = distinct !DISubprogram(name: ".omp_outlined._debug__", scope: !1, file: !1, line: 42, type: !152, scopeLine: 42, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
!152 = !DISubroutineType(types: !153)
!153 = !{null, !35, !35}
!154 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !151, type: !35, flags: DIFlagArtificial)
!155 = !DILocation(line: 0, scope: !151)
!156 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !151, type: !35, flags: DIFlagArtificial)
!157 = !DILocation(line: 42, column: 3, scope: !151)
!158 = !DILocation(line: 43, column: 3, scope: !159)
!159 = distinct !DILexicalBlock(scope: !151, file: !1, line: 42, column: 3)
!160 = !DILocation(line: 42, column: 21, scope: !159)
!161 = !DILocation(line: 42, column: 21, scope: !151)
!162 = distinct !DISubprogram(name: ".omp_outlined..7", scope: !1, file: !1, line: 42, type: !152, scopeLine: 42, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
!163 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !162, type: !35, flags: DIFlagArtificial)
!164 = !DILocation(line: 0, scope: !162)
!165 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !162, type: !35, flags: DIFlagArtificial)
!166 = !DILocation(line: 42, column: 3, scope: !162)
!167 = !{!168}
