...
@1 = private unnamed_addr constant [45 x i8] c";DRB131-taskdep4-orig-omp45-yes.c;foo;24;3;;\00", align 1
@2 = private unnamed_addr constant [45 x i8] c";DRB131-taskdep4-orig-omp45-yes.c;foo;27;3;;\00", align 1
@3 = private unnamed_addr constant [45 x i8] c";DRB131-taskdep4-orig-omp45-yes.c;foo;30;3;;\00", align 1
...
@4 = private unnamed_addr constant [45 x i8] c";DRB131-taskdep4-orig-omp45-yes.c;foo;35;3;;\00", align 1
@5 = private unnamed_addr constant [46 x i8] c";DRB131-taskdep4-orig-omp45-yes.c;main;41;3;;\00", align 1
@6 = private unnamed_addr constant [46 x i8] c";DRB131-taskdep4-orig-omp45-yes.c;main;40;3;;\00", align 1
...
entry:
  ...
  store i8* getelementptr inbounds ([45 x i8], [45 x i8]* @2, i32 0, i32 0), i8** %22, align 8, !dbg !16
  ...
  store i8* getelementptr inbounds ([45 x i8], [45 x i8]* @2, i32 0, i32 0), i8** %29, align 8, !dbg !16
  ...
  store i8* getelementptr inbounds ([45 x i8], [45 x i8]* @3, i32 0, i32 0), i8** %31, align 8, !dbg !17
  ...
  store i8* getelementptr inbounds ([45 x i8], [45 x i8]* @3, i32 0, i32 0), i8** %42, align 8, !dbg !17
  ...
  %45 = load i32, i32* %y, align 4, !dbg !24
  %call4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.6, i64 0, i64 0), i32 %45), !dbg !25
  %46 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !26
  store i8* getelementptr inbounds ([45 x i8], [45 x i8]* @4, i32 0, i32 0), i8** %46, align 8, !dbg !26
  %47 = call i32 @__kmpc_omp_taskwait(%struct.ident_t* %.kmpc_loc.addr, i32 %3), !dbg !26
  ret void, !dbg !27
}
...
entry:
  ...
  store i8* getelementptr inbounds ([46 x i8], [46 x i8]* @6, i32 0, i32 0), i8** %2, align 8, !dbg !148
...
entry:
  ...
  store i8* getelementptr inbounds ([46 x i8], [46 x i8]* @5, i32 0, i32 0), i8** %2, align 8, !dbg !156
...
omp_if.end:                                       ; preds = %omp_if.then, %entry
  ...
  store i8* getelementptr inbounds ([46 x i8], [46 x i8]* @5, i32 0, i32 0), i8** %7, align 8, !dbg !159
...
!1 = !DIFile(filename: "DRB131-taskdep4-orig-omp45-yes.c", directory: "/home/yanze/code/OpenRace/tests/data/integration/dataracebench")
!2 = !{}
...
!88 = distinct !DICompositeType(tag: DW_TAG_structure_type, scope: !7, file: !1, line: 27, size: 64, elements: !2)
...
!112 = !DILocation(line: 28, column: 4, scope: !82, inlinedAt: !90)
!113 = distinct !DISubprogram(linkageName: ".omp_task_entry..4", scope: !1, file: !1, line: 30, type: !29, scopeLine: 30, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
!114 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !115, type: !34, flags: DIFlagArtificial)
!115 = distinct !DISubprogram(name: ".omp_outlined..3", scope: !1, file: !1, line: 30, type: !116, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
...
!121 = distinct !DICompositeType(tag: DW_TAG_structure_type, scope: !7, file: !1, line: 30, elements: !2)
!122 = !DILocation(line: 0, scope: !115, inlinedAt: !123)
!123 = distinct !DILocation(line: 30, column: 3, scope: !113)
...
!137 = !DILocation(line: 30, column: 3, scope: !113)
!138 = !{!139, !141, !142, !143}
...
!144 = !DILocation(line: 31, column: 3, scope: !115, inlinedAt: !123)
