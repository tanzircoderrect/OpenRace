...
@1 = private unnamed_addr constant [40 x i8] c";DRB063-outeronly1-orig-no.c;foo;57;1;;\00", align 1
...
for.cond:                                         ; preds = %for.inc, %omp.inner.for.body
  ...
  %sub8 = sub nsw i32 %18, 1, !dbg !56
  %cmp9 = icmp slt i32 %17, %sub8, !dbg !57
  br i1 %cmp9, label %for.body, label %for.end, !dbg !58

for.body:                                         ; preds = %for.cond
  %19 = load i32, i32* %i4, align 4, !dbg !59
  %idxprom = sext i32 %19 to i64, !dbg !60
  %arrayidx = getelementptr inbounds [100 x [100 x double]], [100 x [100 x double]]* @b, i64 0, i64 %idxprom, !dbg !60
  %20 = load i32, i32* %j, align 4, !dbg !61
  %add10 = add nsw i32 %20, 1, !dbg !62
  %idxprom11 = sext i32 %add10 to i64, !dbg !60
  %arrayidx12 = getelementptr inbounds [100 x double], [100 x double]* %arrayidx, i64 0, i64 %idxprom11, !dbg !60
  %21 = load double, double* %arrayidx12, align 8, !dbg !60
  %22 = load i32, i32* %i4, align 4, !dbg !63
  %idxprom13 = sext i32 %22 to i64, !dbg !64
  %arrayidx14 = getelementptr inbounds [100 x [100 x double]], [100 x [100 x double]]* @b, i64 0, i64 %idxprom13, !dbg !64
  %23 = load i32, i32* %j, align 4, !dbg !65
  %idxprom15 = sext i32 %23 to i64, !dbg !64
  %arrayidx16 = getelementptr inbounds [100 x double], [100 x double]* %arrayidx14, i64 0, i64 %idxprom15, !dbg !64
  store double %21, double* %arrayidx16, align 8, !dbg !66
  br label %for.inc, !dbg !64

for.inc:                                          ; preds = %for.body
  %24 = load i32, i32* %j, align 4, !dbg !67
  %inc = add nsw i32 %24, 1, !dbg !67
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  ...
  %add17 = add nsw i32 %25, 1, !dbg !41
  store i32 %add17, i32* %.omp.iv, align 4, !dbg !41
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  %26 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !71
  store i8* getelementptr inbounds ([41 x i8], [41 x i8]* @2, i32 0, i32 0), i8** %26, align 8, !dbg !71
  %27 = load i32*, i32** %.global_tid..addr, align 8, !dbg !71
  %28 = load i32, i32* %27, align 4, !dbg !71
  call void @__kmpc_for_static_fini(%struct.ident_t* %.kmpc_loc.addr, i32 %28), !dbg !71
...
; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid.) #2 !dbg !75 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  store i32* %.global_tid., i32** %.global_tid..addr, align 8
  ...
  %0 = load i32*, i32** %.global_tid..addr, align 8, !dbg !79
  %1 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !79
  call void @.omp_outlined._debug__(i32* %0, i32* %1) #4, !dbg !79
  ret void, !dbg !79
}
...
!3 = !DIFile(filename: "DRB063-outeronly1-orig-no.c", directory: "/home/yanze/code/OpenRace/tests/data/integration/dataracebench")
!4 = !{}
!5 = !{!6, !0, !12}
...
!21 = !{null}
!22 = !DILocalVariable(name: "i", scope: !19, file: !3, line: 56, type: !14)
...
!26 = !DILocation(line: 57, column: 1, scope: !19)
!27 = !DILocation(line: 61, column: 1, scope: !19)
!28 = distinct !DISubprogram(name: ".omp_outlined._debug__", scope: !3, file: !3, line: 58, type: !29, scopeLine: 58, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!40 = !DILocation(line: 58, column: 14, scope: !28)
!41 = !DILocation(line: 58, column: 3, scope: !28)
!42 = !DILocalVariable(name: "i", scope: !28, type: !14, flags: DIFlagArtificial)
!43 = !DILocation(line: 58, column: 16, scope: !28)
!44 = !DILocalVariable(name: ".omp.lb", scope: !28, type: !14, flags: DIFlagArtificial)
!45 = !DILocation(line: 58, column: 8, scope: !28)
...
!50 = !DILocation(line: 59, column: 11, scope: !51)
!51 = distinct !DILexicalBlock(scope: !28, file: !3, line: 59, column: 5)
!52 = !DILocation(line: 59, column: 10, scope: !51)
!53 = !DILocation(line: 59, column: 14, scope: !54)
!54 = distinct !DILexicalBlock(scope: !51, file: !3, line: 59, column: 5)
!55 = !DILocation(line: 59, column: 16, scope: !54)
!56 = !DILocation(line: 59, column: 17, scope: !54)
!57 = !DILocation(line: 59, column: 15, scope: !54)
!58 = !DILocation(line: 59, column: 5, scope: !51)
!59 = !DILocation(line: 60, column: 17, scope: !54)
!60 = !DILocation(line: 60, column: 15, scope: !54)
!61 = !DILocation(line: 60, column: 20, scope: !54)
!62 = !DILocation(line: 60, column: 21, scope: !54)
!63 = !DILocation(line: 60, column: 9, scope: !54)
!64 = !DILocation(line: 60, column: 7, scope: !54)
!65 = !DILocation(line: 60, column: 12, scope: !54)
!66 = !DILocation(line: 60, column: 14, scope: !54)
!67 = !DILocation(line: 59, column: 21, scope: !54)
!68 = !DILocation(line: 59, column: 5, scope: !54)
!69 = distinct !{!69, !58, !70}
!70 = !DILocation(line: 60, column: 23, scope: !51)
!71 = !DILocation(line: 57, column: 1, scope: !28)
!72 = distinct !{!72, !71, !73}
!73 = !DILocation(line: 57, column: 36, scope: !28)
!74 = !DILocation(line: 60, column: 23, scope: !28)
!75 = distinct !DISubprogram(name: ".omp_outlined.", scope: !3, file: !3, line: 58, type: !29, scopeLine: 58, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!76 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !75, type: !31, flags: DIFlagArtificial)
!77 = !DILocation(line: 0, scope: !75)
!78 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !75, type: !31, flags: DIFlagArtificial)
!79 = !DILocation(line: 58, column: 3, scope: !75)
!80 = !{!81}
!81 = !{i64 2, i64 -1, i64 -1, i1 true}
!82 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 63, type: !83, scopeLine: 64, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!83 = !DISubroutineType(types: !84)
!84 = !{!14}
!85 = !DILocation(line: 65, column: 3, scope: !82)
!86 = !DILocation(line: 66, column: 3, scope: !82)
