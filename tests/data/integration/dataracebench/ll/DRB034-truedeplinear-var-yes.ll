...
@1 = private unnamed_addr constant [44 x i8] c";DRB034-truedeplinear-var-yes.c;main;64;1;;\00", align 1
...
for.end:                                          ; preds = %for.cond
  ...
  store i8* getelementptr inbounds ([44 x i8], [44 x i8]* @1, i32 0, i32 0), i8** %13, align 8, !dbg !56
...
entry:
  ...
  %div = sdiv i32 %5, 2, !dbg !79
  store i32 %div, i32* %.capture_expr., align 4, !dbg !78
  ...
  %sub = sub nsw i32 %6, 0, !dbg !75
  %sub2 = sub nsw i32 %sub, 1, !dbg !75
  %add = add nsw i32 %sub2, 1, !dbg !75
  %div3 = sdiv i32 %add, 1, !dbg !75
  %sub4 = sub nsw i32 %div3, 1, !dbg !75
...
omp.precond.then:                                 ; preds = %entry
  ...
  store i8* getelementptr inbounds ([44 x i8], [44 x i8]* @1, i32 0, i32 0), i8** %9, align 8, !dbg !75
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %idxprom = sext i32 %20 to i64, !dbg !88
  %arrayidx = getelementptr inbounds i32, i32* %4, i64 %idxprom, !dbg !88
  %21 = load i32, i32* %arrayidx, align 4, !dbg !88
  %add9 = add nsw i32 %21, 1, !dbg !89
  %22 = load i32, i32* %i5, align 4, !dbg !90
  %mul10 = mul nsw i32 2, %22, !dbg !91
  %add11 = add nsw i32 %mul10, 1, !dbg !92
  %idxprom12 = sext i32 %add11 to i64, !dbg !93
  %arrayidx13 = getelementptr inbounds i32, i32* %4, i64 %idxprom12, !dbg !93
  store i32 %add9, i32* %arrayidx13, align 4, !dbg !94
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  ...
  %add14 = add nsw i32 %23, 1, !dbg !75
  store i32 %add14, i32* %.omp.iv, align 4, !dbg !75
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  %24 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !95
  store i8* getelementptr inbounds ([45 x i8], [45 x i8]* @2, i32 0, i32 0), i8** %24, align 8, !dbg !95
  %25 = load i32*, i32** %.global_tid..addr, align 8, !dbg !95
  %26 = load i32, i32* %25, align 4, !dbg !95
  call void @__kmpc_for_static_fini(%struct.ident_t* %.kmpc_loc.addr, i32 %26), !dbg !95
  br label %omp.precond.end, !dbg !95
...
; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid., i32* dereferenceable(4) %len, i64 %vla, i32* dereferenceable(4) %a) #4 !dbg !99 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %len.addr = alloca i32*, align 8
  ...
  store i32* %len, i32** %len.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %len.addr, metadata !103, metadata !DIExpression()), !dbg !101
  store i64 %vla, i64* %vla.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %vla.addr, metadata !104, metadata !DIExpression()), !dbg !101
  store i32* %a, i32** %a.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %a.addr, metadata !105, metadata !DIExpression()), !dbg !101
  %0 = load i32*, i32** %len.addr, align 8, !dbg !106
  %1 = load i64, i64* %vla.addr, align 8, !dbg !106
  %2 = load i32*, i32** %a.addr, align 8, !dbg !106
  %3 = load i32*, i32** %.global_tid..addr, align 8, !dbg !106
  %4 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !106
  %5 = load i32*, i32** %len.addr, align 8, !dbg !106
  %6 = load i32*, i32** %a.addr, align 8, !dbg !106
  call void @.omp_outlined._debug__(i32* %3, i32* %4, i32* %5, i64 %1, i32* %6) #3, !dbg !106
  ret void, !dbg !106
}
...
!1 = !DIFile(filename: "DRB034-truedeplinear-var-yes.c", directory: "/home/yanze/code/OpenRace/tests/data/integration/dataracebench")
!2 = !{}
...
!56 = !DILocation(line: 64, column: 1, scope: !7)
!57 = !DILocation(line: 68, column: 3, scope: !7)
!58 = !DILocation(line: 69, column: 1, scope: !7)
!59 = distinct !DISubprogram(name: ".omp_outlined._debug__", scope: !1, file: !1, line: 65, type: !60, scopeLine: 65, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
...
!73 = !DILocalVariable(name: "a", arg: 5, scope: !59, file: !1, line: 59, type: !66)
!74 = !DILocation(line: 59, column: 7, scope: !59)
!75 = !DILocation(line: 65, column: 3, scope: !59)
...
!78 = !DILocation(line: 65, column: 14, scope: !59)
!79 = !DILocation(line: 65, column: 17, scope: !59)
!80 = !DILocalVariable(name: "i", scope: !59, type: !10, flags: DIFlagArtificial)
!81 = !DILocation(line: 65, column: 20, scope: !59)
!82 = !DILocalVariable(name: ".omp.lb", scope: !59, type: !10, flags: DIFlagArtificial)
!83 = !DILocation(line: 65, column: 8, scope: !59)
...
!87 = !DILocation(line: 66, column: 16, scope: !59)
!88 = !DILocation(line: 66, column: 14, scope: !59)
!89 = !DILocation(line: 66, column: 18, scope: !59)
!90 = !DILocation(line: 66, column: 9, scope: !59)
!91 = !DILocation(line: 66, column: 8, scope: !59)
!92 = !DILocation(line: 66, column: 10, scope: !59)
!93 = !DILocation(line: 66, column: 5, scope: !59)
!94 = !DILocation(line: 66, column: 13, scope: !59)
!95 = !DILocation(line: 64, column: 1, scope: !59)
!96 = distinct !{!96, !95, !97}
!97 = !DILocation(line: 64, column: 25, scope: !59)
!98 = !DILocation(line: 66, column: 19, scope: !59)
!99 = distinct !DISubprogram(name: ".omp_outlined.", scope: !1, file: !1, line: 65, type: !60, scopeLine: 65, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
!100 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !99, type: !62, flags: DIFlagArtificial)
!101 = !DILocation(line: 0, scope: !99)
!102 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !99, type: !62, flags: DIFlagArtificial)
!103 = !DILocalVariable(name: "len", arg: 3, scope: !99, type: !66, flags: DIFlagArtificial)
!104 = !DILocalVariable(name: "vla", arg: 4, scope: !99, type: !33, flags: DIFlagArtificial)
!105 = !DILocalVariable(name: "a", arg: 5, scope: !99, type: !66, flags: DIFlagArtificial)
!106 = !DILocation(line: 65, column: 3, scope: !99)
!107 = !{!108}
