...
@1 = private unnamed_addr constant [48 x i8] c";DRB005-indirectaccess1-orig-yes.c;main;124;1;;\00", align 1
...
entry:
  ...
  call void @__kmpc_for_static_init_4(%struct.ident_t* %.kmpc_loc.addr, i32 %6, i32 33, i32* %.omp.is_last, i32* %.omp.lb, i32* %.omp.ub, i32* %.omp.stride, i32 1, i32 1), !dbg !88
  br label %omp.dispatch.cond, !dbg !88
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  br i1 %cmp1, label %omp.dispatch.body, label %omp.dispatch.end, !dbg !88
...
omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %omp.dispatch.body
  ...
  %13 = load i32, i32* %.omp.ub, align 4, !dbg !91
  %cmp2 = icmp sle i32 %12, %13, !dbg !88
  br i1 %cmp2, label %omp.inner.for.body, label %omp.inner.for.end, !dbg !88

omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %14 = load i32, i32* %.omp.iv, align 4, !dbg !91
  %mul = mul nsw i32 %14, 1, !dbg !96
  ...
  %idxprom = sext i32 %15 to i64, !dbg !101
  %arrayidx = getelementptr inbounds [180 x i32], [180 x i32]* @indexSet, i64 0, i64 %idxprom, !dbg !101
  %16 = load i32, i32* %arrayidx, align 4, !dbg !101
  store i32 %16, i32* %idx, align 4, !dbg !99
  %17 = load i32, i32* %i, align 4, !dbg !102
  %conv = sitofp i32 %17 to double, !dbg !102
  %add3 = fadd double 1.000000e+00, %conv, !dbg !103
  %18 = load double*, double** %2, align 8, !dbg !104
  %19 = load i32, i32* %idx, align 4, !dbg !105
  %idxprom4 = sext i32 %19 to i64, !dbg !104
  %arrayidx5 = getelementptr inbounds double, double* %18, i64 %idxprom4, !dbg !104
  %20 = load double, double* %arrayidx5, align 8, !dbg !106
  %add6 = fadd double %20, %add3, !dbg !106
  store double %add6, double* %arrayidx5, align 8, !dbg !106
  %21 = load i32, i32* %i, align 4, !dbg !107
  %conv7 = sitofp i32 %21 to double, !dbg !107
  %add8 = fadd double 3.000000e+00, %conv7, !dbg !108
  %22 = load double*, double** %3, align 8, !dbg !109
  %23 = load i32, i32* %idx, align 4, !dbg !110
  %idxprom9 = sext i32 %23 to i64, !dbg !109
  %arrayidx10 = getelementptr inbounds double, double* %22, i64 %idxprom9, !dbg !109
  %24 = load double, double* %arrayidx10, align 8, !dbg !111
  %add11 = fadd double %24, %add8, !dbg !111
  store double %add11, double* %arrayidx10, align 8, !dbg !111
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %25 = load i32, i32* %.omp.iv, align 4, !dbg !91
  %add12 = add nsw i32 %25, 1, !dbg !88
  store i32 %add12, i32* %.omp.iv, align 4, !dbg !88
...
omp.dispatch.inc:                                 ; preds = %omp.inner.for.end
  %26 = load i32, i32* %.omp.lb, align 4, !dbg !91
  %27 = load i32, i32* %.omp.stride, align 4, !dbg !91
  %add13 = add nsw i32 %26, %27, !dbg !88
  store i32 %add13, i32* %.omp.lb, align 4, !dbg !88
  %28 = load i32, i32* %.omp.ub, align 4, !dbg !91
  %29 = load i32, i32* %.omp.stride, align 4, !dbg !91
  %add14 = add nsw i32 %28, %29, !dbg !88
  store i32 %add14, i32* %.omp.ub, align 4, !dbg !88
  br label %omp.dispatch.cond, !dbg !113, !llvm.loop !116

omp.dispatch.end:                                 ; preds = %cond.end
  %30 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !113
  store i8* getelementptr inbounds ([49 x i8], [49 x i8]* @2, i32 0, i32 0), i8** %30, align 8, !dbg !113
  call void @__kmpc_for_static_fini(%struct.ident_t* %.kmpc_loc.addr, i32 %6), !dbg !113
  ret void, !dbg !117
}
...
; Function Attrs: noinline norecurse nounwind optnone uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid., double** dereferenceable(8) %xa1, double** dereferenceable(8) %xa2) #4 !dbg !118 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %xa1.addr = alloca double**, align 8
  ...
  store double** %xa1, double*** %xa1.addr, align 8
  call void @llvm.dbg.declare(metadata double*** %xa1.addr, metadata !122, metadata !DIExpression()), !dbg !120
  store double** %xa2, double*** %xa2.addr, align 8
  call void @llvm.dbg.declare(metadata double*** %xa2.addr, metadata !123, metadata !DIExpression()), !dbg !120
  %0 = load double**, double*** %xa1.addr, align 8, !dbg !124
  %1 = load double**, double*** %xa2.addr, align 8, !dbg !124
  %2 = load i32*, i32** %.global_tid..addr, align 8, !dbg !124
  %3 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !124
  %4 = load double**, double*** %xa1.addr, align 8, !dbg !124
  %5 = load double**, double*** %xa2.addr, align 8, !dbg !124
  call void @.omp_outlined._debug__(i32* %2, i32* %3, double** %4, double** %5) #6, !dbg !124
  ret void, !dbg !124
}
...
!3 = !DIFile(filename: "DRB005-indirectaccess1-orig-yes.c", directory: "/home/yanze/code/OpenRace/tests/data/integration/dataracebench")
!4 = !{}
!5 = !{!6}
...
!66 = !DILocation(line: 132, column: 39, scope: !17)
!67 = !DILocation(line: 132, column: 49, scope: !17)
!68 = !DILocation(line: 132, column: 3, scope: !17)
!69 = !DILocation(line: 133, column: 9, scope: !17)
!70 = !DILocation(line: 133, column: 3, scope: !17)
!71 = !DILocation(line: 134, column: 3, scope: !17)
!72 = !DILocation(line: 135, column: 1, scope: !17)
...
!102 = !DILocation(line: 128, column: 22, scope: !98)
!103 = !DILocation(line: 128, column: 20, scope: !98)
!104 = !DILocation(line: 128, column: 5, scope: !98)
!105 = !DILocation(line: 128, column: 9, scope: !98)
!106 = !DILocation(line: 128, column: 13, scope: !98)
!107 = !DILocation(line: 129, column: 22, scope: !98)
!108 = !DILocation(line: 129, column: 20, scope: !98)
!109 = !DILocation(line: 129, column: 5, scope: !98)
!110 = !DILocation(line: 129, column: 9, scope: !98)
!111 = !DILocation(line: 129, column: 13, scope: !98)
!112 = !DILocation(line: 130, column: 3, scope: !98)
!113 = !DILocation(line: 124, column: 1, scope: !73)
!114 = distinct !{!114, !113, !115}
!115 = !DILocation(line: 124, column: 44, scope: !73)
!116 = distinct !{!116, !113, !115}
!117 = !DILocation(line: 130, column: 3, scope: !73)
!118 = distinct !DISubprogram(name: ".omp_outlined.", scope: !3, file: !3, line: 125, type: !74, scopeLine: 125, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!119 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !118, type: !76, flags: DIFlagArtificial)
!120 = !DILocation(line: 0, scope: !118)
!121 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !118, type: !76, flags: DIFlagArtificial)
!122 = !DILocalVariable(name: "xa1", arg: 3, scope: !118, type: !80, flags: DIFlagArtificial)
!123 = !DILocalVariable(name: "xa2", arg: 4, scope: !118, type: !80, flags: DIFlagArtificial)
!124 = !DILocation(line: 125, column: 3, scope: !118)
!125 = !{!126}
