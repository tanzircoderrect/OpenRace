; ModuleID = 'integration/dataracebench/DRB034-truedeplinear-var-yes.c'
source_filename = "integration/dataracebench/DRB034-truedeplinear-var-yes.c"
...
@1 = private unnamed_addr constant [70 x i8] c";integration/dataracebench/DRB034-truedeplinear-var-yes.c;main;64;1;;\00", align 1
@2 = private unnamed_addr constant [71 x i8] c";integration/dataracebench/DRB034-truedeplinear-var-yes.c;main;64;25;;\00", align 1
...
entry:
  ...
  store i32 2000, i32* %len, align 4, !dbg !38, !tbaa !27
...
for.end:                                          ; preds = %for.cond
  ...
  store i8* getelementptr inbounds ([70 x i8], [70 x i8]* @1, i32 0, i32 0), i8** %15, align 8, !dbg !67, !tbaa !68
...
entry:
  ...
  %div = sdiv i32 %7, 2, !dbg !113
  store i32 %div, i32* %.capture_expr., align 4, !dbg !112, !tbaa !27
  ...
  %div3 = sdiv i32 %add, 1, !dbg !111
  %sub4 = sub nsw i32 %div3, 1, !dbg !111
...
omp.precond.then:                                 ; preds = %entry
  ...
  store i8* getelementptr inbounds ([70 x i8], [70 x i8]* @1, i32 0, i32 0), i8** %19, align 8, !dbg !111, !tbaa !68
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %idxprom = sext i32 %30 to i64, !dbg !117
  %arrayidx = getelementptr inbounds i32, i32* %4, i64 %idxprom, !dbg !117
  %31 = load i32, i32* %arrayidx, align 4, !dbg !117, !tbaa !27
  %add9 = add nsw i32 %31, 1, !dbg !118
  %32 = load i32, i32* %i5, align 4, !dbg !119, !tbaa !27
  %mul10 = mul nsw i32 2, %32, !dbg !120
  %add11 = add nsw i32 %mul10, 1, !dbg !121
  %idxprom12 = sext i32 %add11 to i64, !dbg !122
  %arrayidx13 = getelementptr inbounds i32, i32* %4, i64 %idxprom12, !dbg !122
  store i32 %add9, i32* %arrayidx13, align 4, !dbg !123, !tbaa !27
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  ...
  %add14 = add nsw i32 %33, 1, !dbg !111
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  store i8* getelementptr inbounds ([71 x i8], [71 x i8]* @2, i32 0, i32 0), i8** %34, align 8, !dbg !124, !tbaa !68
  %35 = load i32*, i32** %.global_tid..addr, align 8, !dbg !124
  %36 = load i32, i32* %35, align 4, !dbg !124, !tbaa !27
  call void @__kmpc_for_static_fini(%struct.ident_t* %.kmpc_loc.addr, i32 %36), !dbg !124
  %37 = bitcast i32* %i5 to i8*, !dbg !124
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %37) #4, !dbg !124
  %38 = bitcast i32* %.omp.is_last to i8*, !dbg !124
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %38) #4, !dbg !124
  %39 = bitcast i32* %.omp.stride to i8*, !dbg !124
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %39) #4, !dbg !124
  %40 = bitcast i32* %.omp.ub to i8*, !dbg !124
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %40) #4, !dbg !124
  %41 = bitcast i32* %.omp.lb to i8*, !dbg !124
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %41) #4, !dbg !124
  br label %omp.precond.end, !dbg !124

omp.precond.end:                                  ; preds = %omp.loop.exit, %entry
  %42 = bitcast i32* %.capture_expr.1 to i8*, !dbg !124
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %42) #4, !dbg !124
  %43 = bitcast i32* %.capture_expr. to i8*, !dbg !124
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %43) #4, !dbg !124
  %44 = bitcast i32* %.omp.iv to i8*, !dbg !124
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %44) #4, !dbg !124
  ret void, !dbg !127
}
...
; Function Attrs: norecurse nounwind uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid., i32* dereferenceable(4) %len, i64 %vla, i32* dereferenceable(4) %a) #5 !dbg !128 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %len.addr = alloca i32*, align 8
  ...
  %0 = load i32*, i32** %len.addr, align 8, !dbg !136, !tbaa !32
  %1 = load i64, i64* %vla.addr, align 8, !dbg !136, !tbaa !108
  %2 = load i32*, i32** %a.addr, align 8, !dbg !136, !tbaa !32
  %3 = load i32*, i32** %.global_tid..addr, align 8, !dbg !136, !tbaa !32
  %4 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !136, !tbaa !32
  %5 = load i32*, i32** %len.addr, align 8, !dbg !136, !tbaa !32
  %6 = load i32*, i32** %a.addr, align 8, !dbg !136, !tbaa !32
...
!1 = !DIFile(filename: "integration/dataracebench/DRB034-truedeplinear-var-yes.c", directory: "/home/brad/Code/OpenRace/tests/data")
!2 = !{}
!3 = !{!4, !5, !8}
...
!23 = !DILocalVariable(name: "a", scope: !13, file: !1, line: 59, type: !24)
...
!47 = !DILocation(line: 59, column: 9, scope: !13)
!48 = !DILocation(line: 59, column: 3, scope: !13)
!49 = !DILocation(line: 0, scope: !13)
!50 = !DILocation(line: 59, column: 7, scope: !13)
!51 = !DILocation(line: 61, column: 9, scope: !52)
!52 = distinct !DILexicalBlock(scope: !13, file: !1, line: 61, column: 3)
!53 = !DILocation(line: 61, column: 8, scope: !52)
!54 = !DILocation(line: 61, column: 13, scope: !55)
!55 = distinct !DILexicalBlock(scope: !52, file: !1, line: 61, column: 3)
!56 = !DILocation(line: 61, column: 15, scope: !55)
!57 = !DILocation(line: 61, column: 14, scope: !55)
!58 = !DILocation(line: 61, column: 3, scope: !52)
!59 = !DILocation(line: 62, column: 10, scope: !55)
!60 = !DILocation(line: 62, column: 7, scope: !55)
!61 = !DILocation(line: 62, column: 5, scope: !55)
!62 = !DILocation(line: 62, column: 9, scope: !55)
!63 = !DILocation(line: 61, column: 21, scope: !55)
!64 = !DILocation(line: 61, column: 3, scope: !55)
!65 = distinct !{!65, !58, !66}
!66 = !DILocation(line: 62, column: 10, scope: !52)
!67 = !DILocation(line: 64, column: 1, scope: !13)
!68 = !{!69, !33, i64 16}
!69 = !{!"ident_t", !28, i64 0, !28, i64 4, !28, i64 8, !28, i64 12, !33, i64 16}
!70 = !DILocation(line: 68, column: 3, scope: !13)
!71 = !DILocation(line: 69, column: 1, scope: !13)
...
!85 = distinct !DISubprogram(name: ".omp_outlined._debug__", scope: !1, file: !1, line: 65, type: !86, scopeLine: 65, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !93)
...
!98 = !DILocalVariable(name: "a", arg: 5, scope: !85, file: !1, line: 59, type: !92)
...
!108 = !{!109, !109, i64 0}
!109 = !{!"long", !29, i64 0}
!110 = !DILocation(line: 59, column: 7, scope: !85)
!111 = !DILocation(line: 65, column: 3, scope: !85)
!112 = !DILocation(line: 65, column: 14, scope: !85)
!113 = !DILocation(line: 65, column: 17, scope: !85)
!114 = !DILocation(line: 65, column: 20, scope: !85)
!115 = !DILocation(line: 65, column: 8, scope: !85)
!116 = !DILocation(line: 66, column: 16, scope: !85)
!117 = !DILocation(line: 66, column: 14, scope: !85)
!118 = !DILocation(line: 66, column: 18, scope: !85)
!119 = !DILocation(line: 66, column: 9, scope: !85)
!120 = !DILocation(line: 66, column: 8, scope: !85)
!121 = !DILocation(line: 66, column: 10, scope: !85)
!122 = !DILocation(line: 66, column: 5, scope: !85)
!123 = !DILocation(line: 66, column: 13, scope: !85)
!124 = !DILocation(line: 64, column: 1, scope: !85)
!125 = distinct !{!125, !124, !126}
!126 = !DILocation(line: 64, column: 25, scope: !85)
!127 = !DILocation(line: 66, column: 19, scope: !85)
!128 = distinct !DISubprogram(name: ".omp_outlined.", scope: !1, file: !1, line: 65, type: !86, scopeLine: 65, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !129)
!129 = !{!130, !131, !132, !133, !134}
!130 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !128, type: !88, flags: DIFlagArtificial)
!131 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !128, type: !88, flags: DIFlagArtificial)
!132 = !DILocalVariable(name: "len", arg: 3, scope: !128, type: !92, flags: DIFlagArtificial)
!133 = !DILocalVariable(name: "vla", arg: 4, scope: !128, type: !22, flags: DIFlagArtificial)
!134 = !DILocalVariable(name: "a", arg: 5, scope: !128, type: !92, flags: DIFlagArtificial)
!135 = !DILocation(line: 0, scope: !128)
!136 = !DILocation(line: 65, column: 3, scope: !128)
!137 = !{!138}
