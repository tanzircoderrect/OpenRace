; ModuleID = 'integration/dataracebench/DRB144-critical-missingreduction-orig-gpu-yes.c'
source_filename = "integration/dataracebench/DRB144-critical-missingreduction-orig-gpu-yes.c"
...
@1 = private unnamed_addr constant [87 x i8] c";integration/dataracebench/DRB144-critical-missingreduction-orig-gpu-yes.c;main;23;3;;\00", align 1
...
@3 = private unnamed_addr constant [87 x i8] c";integration/dataracebench/DRB144-critical-missingreduction-orig-gpu-yes.c;main;25;5;;\00", align 1
@.gomp_critical_user_.var = common global [8 x i32] zeroinitializer
@4 = private unnamed_addr constant [88 x i8] c";integration/dataracebench/DRB144-critical-missingreduction-orig-gpu-yes.c;main;23;44;;\00", align 1
...
entry:
  ...
  call void @__omp_offloading_1030a_2160952_main_l22(i32* @var) #5, !dbg !14
  %0 = load i32, i32* @var, align 4, !dbg !16, !tbaa !17
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 %0), !dbg !21
  ret i32 0, !dbg !22
}

; Function Attrs: norecurse nounwind uwtable
define internal void @__omp_offloading_1030a_2160952_main_l22_debug__(i32* dereferenceable(4) %var) #1 !dbg !23 {
entry:
  ...
  store i8* getelementptr inbounds ([87 x i8], [87 x i8]* @1, i32 0, i32 0), i8** %3, align 8, !dbg !32, !tbaa !33
...
entry:
  ...
  store i32 199, i32* %.omp.comb.ub, align 4, !dbg !56, !tbaa !17
  ...
  store i8* getelementptr inbounds ([87 x i8], [87 x i8]* @1, i32 0, i32 0), i8** %9, align 8, !dbg !55, !tbaa !33
  ...
  %cmp = icmp sgt i32 %12, 199, !dbg !56
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ 199, %cond.true ], [ %13, %cond.false ], !dbg !56
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  store i8* getelementptr inbounds ([87 x i8], [87 x i8]* @1, i32 0, i32 0), i8** %21, align 8, !dbg !57, !tbaa !33
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  store i8* getelementptr inbounds ([87 x i8], [87 x i8]* @1, i32 0, i32 0), i8** %24, align 8, !dbg !58, !tbaa !33
...
entry:
  ...
  store i32 199, i32* %.omp.ub, align 4, !dbg !85, !tbaa !17
  ...
  store i8* getelementptr inbounds ([87 x i8], [87 x i8]* @1, i32 0, i32 0), i8** %11, align 8, !dbg !84, !tbaa !33
  ...
  %cmp = icmp sgt i32 %14, 199, !dbg !85
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ 199, %cond.true ], [ %15, %cond.false ], !dbg !85
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  store i8* getelementptr inbounds ([87 x i8], [87 x i8]* @3, i32 0, i32 0), i8** %20, align 8, !dbg !87, !tbaa !33
  call void @__kmpc_critical(%struct.ident_t* %.kmpc_loc.addr, i32 %13, [8 x i32]* @.gomp_critical_user_.var), !dbg !87
  %21 = load i32, i32* %2, align 4, !dbg !89, !tbaa !17
  %inc = add nsw i32 %21, 1, !dbg !89
  store i32 %inc, i32* %2, align 4, !dbg !89, !tbaa !17
  call void @__kmpc_end_critical(%struct.ident_t* %.kmpc_loc.addr, i32 %13, [8 x i32]* @.gomp_critical_user_.var), !dbg !91
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %22 = load i32, i32* %.omp.iv, align 4, !dbg !85, !tbaa !17
  %add5 = add nsw i32 %22, 1, !dbg !84
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  store i8* getelementptr inbounds ([88 x i8], [88 x i8]* @4, i32 0, i32 0), i8** %23, align 8, !dbg !93, !tbaa !33
  call void @__kmpc_for_static_fini(%struct.ident_t* %.kmpc_loc.addr, i32 %13), !dbg !93
...
; Function Attrs: norecurse nounwind uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid., i64 %.previous.lb., i64 %.previous.ub., i32* dereferenceable(4) %var) #1 !dbg !97 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %.previous.lb..addr = alloca i64, align 8
  ...
  %0 = load i32*, i32** %var.addr, align 8, !dbg !105, !tbaa !29
  %1 = load i32*, i32** %.global_tid..addr, align 8, !dbg !105, !tbaa !29
  %2 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !105, !tbaa !29
  %3 = load i64, i64* %.previous.lb..addr, align 8, !dbg !105, !tbaa !81
  %4 = load i64, i64* %.previous.ub..addr, align 8, !dbg !105, !tbaa !81
  %5 = load i32*, i32** %var.addr, align 8, !dbg !105, !tbaa !29
...
; Function Attrs: norecurse nounwind uwtable
define internal void @.omp_outlined..2(i32* noalias %.global_tid., i32* noalias %.bound_tid., i32* dereferenceable(4) %var) #1 !dbg !108 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %var.addr = alloca i32*, align 8
  ...
  %0 = load i32*, i32** %var.addr, align 8, !dbg !114, !tbaa !29
  %1 = load i32*, i32** %.global_tid..addr, align 8, !dbg !114, !tbaa !29
  %2 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !114, !tbaa !29
  %3 = load i32*, i32** %var.addr, align 8, !dbg !114, !tbaa !29
  call void @.omp_outlined._debug__(i32* %1, i32* %2, i32* %3) #5, !dbg !114
  ret void, !dbg !114
}

declare !callback !106 dso_local void @__kmpc_fork_teams(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...)

; Function Attrs: norecurse nounwind uwtable
define internal void @__omp_offloading_1030a_2160952_main_l22(i32* dereferenceable(4) %var) #1 !dbg !115 {
entry:
  %var.addr = alloca i32*, align 8
  store i32* %var, i32** %var.addr, align 8, !tbaa !29
  call void @llvm.dbg.declare(metadata i32** %var.addr, metadata !117, metadata !DIExpression()), !dbg !118
  %0 = load i32*, i32** %var.addr, align 8, !dbg !119, !tbaa !29
  %1 = load i32*, i32** %var.addr, align 8, !dbg !119, !tbaa !29
  call void @__omp_offloading_1030a_2160952_main_l22_debug__(i32* %1) #5, !dbg !119
  ret void, !dbg !119
}
...
!3 = !DIFile(filename: "integration/dataracebench/DRB144-critical-missingreduction-orig-gpu-yes.c", directory: "/home/brad/Code/OpenRace/tests/data")
!4 = !{}
!5 = !{!0}
...
!20 = !{!"Simple C/C++ TBAA"}
!21 = !DILocation(line: 29, column: 3, scope: !11)
!22 = !DILocation(line: 31, column: 3, scope: !11)
!23 = distinct !DISubprogram(name: "__omp_offloading_1030a_2160952_main_l22_debug__", scope: !3, file: !3, line: 23, type: !24, scopeLine: 23, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !27)
...
!35 = !DILocation(line: 23, column: 44, scope: !23)
...
!73 = !DILocalVariable(name: "var", arg: 5, scope: !63, file: !3, line: 19, type: !26)
...
!86 = !DILocation(line: 24, column: 23, scope: !63)
!87 = !DILocation(line: 25, column: 5, scope: !88)
!88 = distinct !DILexicalBlock(scope: !63, file: !3, line: 24, column: 27)
!89 = !DILocation(line: 26, column: 8, scope: !90)
!90 = distinct !DILexicalBlock(scope: !88, file: !3, line: 25, column: 5)
!91 = !DILocation(line: 26, column: 5, scope: !90)
!92 = !DILocation(line: 27, column: 3, scope: !88)
!93 = !DILocation(line: 23, column: 3, scope: !63)
!94 = distinct !{!94, !93, !95}
!95 = !DILocation(line: 23, column: 44, scope: !63)
!96 = !DILocation(line: 27, column: 3, scope: !63)
!97 = distinct !DISubprogram(name: ".omp_outlined.", scope: !3, file: !3, line: 24, type: !64, scopeLine: 24, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !98)
...
!103 = !DILocalVariable(name: "var", arg: 5, scope: !97, type: !26, flags: DIFlagArtificial)
!104 = !DILocation(line: 0, scope: !97)
!105 = !DILocation(line: 24, column: 3, scope: !97)
!106 = !{!107}
!107 = !{i64 2, i64 -1, i64 -1, i1 true}
!108 = distinct !DISubprogram(name: ".omp_outlined..2", scope: !3, file: !3, line: 24, type: !37, scopeLine: 24, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !109)
!109 = !{!110, !111, !112}
...
!112 = !DILocalVariable(name: "var", arg: 3, scope: !108, type: !26, flags: DIFlagArtificial)
!113 = !DILocation(line: 0, scope: !108)
!114 = !DILocation(line: 24, column: 3, scope: !108)
!115 = distinct !DISubprogram(name: "__omp_offloading_1030a_2160952_main_l22", scope: !3, file: !3, line: 23, type: !24, scopeLine: 23, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !116)
!116 = !{!117}
!117 = !DILocalVariable(name: "var", arg: 1, scope: !115, type: !26, flags: DIFlagArtificial)
!118 = !DILocation(line: 0, scope: !115)
!119 = !DILocation(line: 23, column: 3, scope: !115)
