; ModuleID = 'integration/dataracebench/DRB124-master-orig-yes.c'
source_filename = "integration/dataracebench/DRB124-master-orig-yes.c"
...
@1 = private unnamed_addr constant [64 x i8] c";integration/dataracebench/DRB124-master-orig-yes.c;main;31;5;;\00", align 1
@2 = private unnamed_addr constant [64 x i8] c";integration/dataracebench/DRB124-master-orig-yes.c;main;29;3;;\00", align 1
...
entry:
  ...
  store i8* getelementptr inbounds ([64 x i8], [64 x i8]* @2, i32 0, i32 0), i8** %4, align 8, !dbg !30, !tbaa !31
...
entry:
  ...
  store i8* getelementptr inbounds ([64 x i8], [64 x i8]* @1, i32 0, i32 0), i8** %4, align 8, !dbg !51, !tbaa !31
  %5 = load i32*, i32** %.global_tid..addr, align 8, !dbg !51
  %6 = load i32, i32* %5, align 4, !dbg !51, !tbaa !19
  %7 = call i32 @__kmpc_master(%struct.ident_t* %.kmpc_loc.addr, i32 %6), !dbg !51
...
omp_if.end:                                       ; preds = %omp_if.then, %entry
  %9 = load i32, i32* %2, align 4, !dbg !57, !tbaa !19
  store i32 %9, i32* %local, align 4, !dbg !58, !tbaa !19
  %10 = bitcast i32* %local to i8*, !dbg !59
...
; Function Attrs: norecurse nounwind uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid., i32* dereferenceable(4) %init) #3 !dbg !61 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %init.addr = alloca i32*, align 8
  ...
  %0 = load i32*, i32** %init.addr, align 8, !dbg !67, !tbaa !24
  %1 = load i32*, i32** %.global_tid..addr, align 8, !dbg !67, !tbaa !24
  %2 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !67, !tbaa !24
  %3 = load i32*, i32** %init.addr, align 8, !dbg !67, !tbaa !24
  call void @.omp_outlined._debug__(i32* %1, i32* %2, i32* %3) #4, !dbg !67
  ret void, !dbg !67
}
...
!1 = !DIFile(filename: "integration/dataracebench/DRB124-master-orig-yes.c", directory: "/home/brad/Code/OpenRace/tests/data")
!2 = !{}
...
!33 = !DILocation(line: 40, column: 1, scope: !7)
...
!61 = distinct !DISubprogram(name: ".omp_outlined.", scope: !1, file: !1, line: 30, type: !36, scopeLine: 30, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !62)
!62 = !{!63, !64, !65}
...
!67 = !DILocation(line: 30, column: 3, scope: !61)
!68 = !{!69}
