...
entry:
  ...
  store i8* getelementptr inbounds ([47 x i8], [47 x i8]* @1, i32 0, i32 0), i8** %2, align 8, !tbaa !19
  ...
  store i8* getelementptr inbounds ([47 x i8], [47 x i8]* @1, i32 0, i32 0), i8** %5, align 8, !dbg !27, !tbaa !19
  ...
  store i8* getelementptr inbounds ([47 x i8], [47 x i8]* @1, i32 0, i32 0), i8** %18, align 8, !dbg !27, !tbaa !19
...
entry:
  ...
  store i8* getelementptr inbounds ([43 x i8], [43 x i8]* @3, i32 0, i32 0), i8** %3, align 8, !dbg !108, !tbaa !19
...
entry:
  ...
  store i8* getelementptr inbounds ([43 x i8], [43 x i8]* @2, i32 0, i32 0), i8** %3, align 8, !dbg !150, !tbaa !19
...
omp_if.end:                                       ; preds = %for.end, %entry
  ...
  store i8* getelementptr inbounds ([43 x i8], [43 x i8]* @2, i32 0, i32 0), i8** %14, align 8, !dbg !171, !tbaa !19
...
!3 = !DIFile(filename: "DRB101-task-value-orig-no.cpp", directory: "/home/tanzir/OpenRace/tests/data/integration/dataracebench")
!4 = !{}
!5 = !{!0}
