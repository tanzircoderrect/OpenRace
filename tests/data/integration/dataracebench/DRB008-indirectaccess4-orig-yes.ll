; ModuleID = 'integration/dataracebench/DRB008-indirectaccess4-orig-yes.c'
source_filename = "integration/dataracebench/DRB008-indirectaccess4-orig-yes.c"
...
@1 = private unnamed_addr constant [74 x i8] c";integration/dataracebench/DRB008-indirectaccess4-orig-yes.c;main;124;1;;\00", align 1
...
@2 = private unnamed_addr constant [75 x i8] c";integration/dataracebench/DRB008-indirectaccess4-orig-yes.c;main;124;86;;\00", align 1
...
entry:
  ...
  call void @__kmpc_for_static_init_4(%struct.ident_t* %.kmpc_loc.addr, i32 %12, i32 34, i32* %.omp.is_last, i32* %.omp.lb, i32* %.omp.ub, i32* %.omp.stride, i32 1, i32 1), !dbg !117
...
omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %cond.end
  ...
  br i1 %cmp1, label %omp.inner.for.body, label %omp.inner.for.cond.cleanup, !dbg !117
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %mul = mul nsw i32 %18, 1, !dbg !119
  %add = add nsw i32 0, %mul, !dbg !119
  store i32 %add, i32* %i, align 4, !dbg !119, !tbaa !35
  %19 = bitcast i32* %idx to i8*, !dbg !120
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %19) #6, !dbg !120
  call void @llvm.dbg.declare(metadata i32* %idx, metadata !112, metadata !DIExpression()), !dbg !121
  %20 = load i32, i32* %i, align 4, !dbg !122, !tbaa !35
  %idxprom = sext i32 %20 to i64, !dbg !123
  %arrayidx = getelementptr inbounds [180 x i32], [180 x i32]* @indexSet, i64 0, i64 %idxprom, !dbg !123
  %21 = load i32, i32* %arrayidx, align 4, !dbg !123, !tbaa !35
  store i32 %21, i32* %idx, align 4, !dbg !121, !tbaa !35
  %22 = load double*, double** %2, align 8, !dbg !124, !tbaa !40
  %23 = load i32, i32* %idx, align 4, !dbg !125, !tbaa !35
  %idxprom2 = sext i32 %23 to i64, !dbg !124
  %arrayidx3 = getelementptr inbounds double, double* %22, i64 %idxprom2, !dbg !124
  %24 = load double, double* %arrayidx3, align 8, !dbg !126, !tbaa !76
  %add4 = fadd double %24, 1.000000e+00, !dbg !126
  store double %add4, double* %arrayidx3, align 8, !dbg !126, !tbaa !76
  %25 = load double*, double** %3, align 8, !dbg !127, !tbaa !40
  %26 = load i32, i32* %idx, align 4, !dbg !128, !tbaa !35
  %idxprom5 = sext i32 %26 to i64, !dbg !127
  %arrayidx6 = getelementptr inbounds double, double* %25, i64 %idxprom5, !dbg !127
  %27 = load double, double* %arrayidx6, align 8, !dbg !129, !tbaa !76
  %add7 = fadd double %27, 3.000000e+00, !dbg !129
  store double %add7, double* %arrayidx6, align 8, !dbg !129, !tbaa !76
  %28 = bitcast i32* %idx to i8*, !dbg !130
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %28) #6, !dbg !130
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %29 = load i32, i32* %.omp.iv, align 4, !dbg !118, !tbaa !35
  %add8 = add nsw i32 %29, 1, !dbg !117
  store i32 %add8, i32* %.omp.iv, align 4, !dbg !117, !tbaa !35
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  %30 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !132
  store i8* getelementptr inbounds ([75 x i8], [75 x i8]* @2, i32 0, i32 0), i8** %30, align 8, !dbg !132, !tbaa !84
  call void @__kmpc_for_static_fini(%struct.ident_t* %.kmpc_loc.addr, i32 %12), !dbg !132
  %31 = bitcast i32* %i to i8*, !dbg !132
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %31) #6, !dbg !132
  %32 = bitcast i32* %.omp.is_last to i8*, !dbg !132
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %32) #6, !dbg !132
  %33 = bitcast i32* %.omp.stride to i8*, !dbg !132
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %33) #6, !dbg !132
  %34 = bitcast i32* %.omp.ub to i8*, !dbg !132
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %34) #6, !dbg !132
  %35 = bitcast i32* %.omp.lb to i8*, !dbg !132
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %35) #6, !dbg !132
  %36 = bitcast i32* %.omp.iv to i8*, !dbg !132
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %36) #6, !dbg !132
  ret void, !dbg !130
}
...
; Function Attrs: norecurse nounwind uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid., double** dereferenceable(8) %xa1, double** dereferenceable(8) %xa2) #5 !dbg !135 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %xa1.addr = alloca double**, align 8
  ...
  store double** %xa1, double*** %xa1.addr, align 8, !tbaa !40
  call void @llvm.dbg.declare(metadata double*** %xa1.addr, metadata !139, metadata !DIExpression()), !dbg !141
  store double** %xa2, double*** %xa2.addr, align 8, !tbaa !40
  call void @llvm.dbg.declare(metadata double*** %xa2.addr, metadata !140, metadata !DIExpression()), !dbg !141
  %0 = load double**, double*** %xa1.addr, align 8, !dbg !142, !tbaa !40
  %1 = load double**, double*** %xa2.addr, align 8, !dbg !142, !tbaa !40
  %2 = load i32*, i32** %.global_tid..addr, align 8, !dbg !142, !tbaa !40
  %3 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !142, !tbaa !40
  %4 = load double**, double*** %xa1.addr, align 8, !dbg !142, !tbaa !40
  %5 = load double**, double*** %xa2.addr, align 8, !dbg !142, !tbaa !40
  call void @.omp_outlined._debug__(i32* %2, i32* %3, double** %4, double** %5) #6, !dbg !142
  ret void, !dbg !142
}
...
!1 = distinct !DIGlobalVariable(name: "indexSet", scope: !2, file: !3, line: 69, type: !14, isLocal: false, isDefinition: true)
...
!3 = !DIFile(filename: "integration/dataracebench/DRB008-indirectaccess4-orig-yes.c", directory: "/home/brad/Code/OpenRace/tests/data")
!4 = !{}
!5 = !{!6, !8}
...
!22 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 106, type: !23, scopeLine: 107, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !28)
...
!29 = !DILocalVariable(name: "argc", arg: 1, scope: !22, file: !3, line: 106, type: !15)
!30 = !DILocalVariable(name: "argv", arg: 2, scope: !22, file: !3, line: 106, type: !25)
!31 = !DILocalVariable(name: "base", scope: !22, file: !3, line: 108, type: !6)
...
!38 = !{!"Simple C/C++ TBAA"}
!39 = !DILocation(line: 106, column: 15, scope: !22)
!40 = !{!41, !41, i64 0}
!41 = !{!"any pointer", !37, i64 0}
!42 = !DILocation(line: 106, column: 27, scope: !22)
!43 = !DILocation(line: 108, column: 3, scope: !22)
!44 = !DILocation(line: 108, column: 12, scope: !22)
!45 = !DILocation(line: 108, column: 29, scope: !22)
!46 = !DILocation(line: 108, column: 19, scope: !22)
!47 = !DILocation(line: 109, column: 7, scope: !48)
!48 = distinct !DILexicalBlock(scope: !22, file: !3, line: 109, column: 7)
!49 = !DILocation(line: 109, column: 12, scope: !48)
!50 = !DILocation(line: 109, column: 7, scope: !22)
!51 = !DILocation(line: 111, column: 5, scope: !52)
!52 = distinct !DILexicalBlock(scope: !48, file: !3, line: 110, column: 3)
...
!86 = !DILocation(line: 131, column: 39, scope: !22)
!87 = !DILocation(line: 131, column: 49, scope: !22)
!88 = !DILocation(line: 131, column: 3, scope: !22)
!89 = !DILocation(line: 132, column: 9, scope: !22)
!90 = !DILocation(line: 132, column: 3, scope: !22)
!91 = !DILocation(line: 133, column: 3, scope: !22)
!92 = !DILocation(line: 134, column: 1, scope: !22)
...
!124 = !DILocation(line: 128, column: 5, scope: !113)
!125 = !DILocation(line: 128, column: 9, scope: !113)
!126 = !DILocation(line: 128, column: 13, scope: !113)
!127 = !DILocation(line: 129, column: 5, scope: !113)
!128 = !DILocation(line: 129, column: 9, scope: !113)
!129 = !DILocation(line: 129, column: 13, scope: !113)
!130 = !DILocation(line: 130, column: 3, scope: !93)
!131 = !DILocation(line: 130, column: 3, scope: !113)
!132 = !DILocation(line: 124, column: 1, scope: !93)
!133 = distinct !{!133, !132, !134}
!134 = !DILocation(line: 124, column: 86, scope: !93)
!135 = distinct !DISubprogram(name: ".omp_outlined.", scope: !3, file: !3, line: 125, type: !94, scopeLine: 125, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !136)
!136 = !{!137, !138, !139, !140}
!137 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !135, type: !96, flags: DIFlagArtificial)
!138 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !135, type: !96, flags: DIFlagArtificial)
!139 = !DILocalVariable(name: "xa1", arg: 3, scope: !135, type: !100, flags: DIFlagArtificial)
!140 = !DILocalVariable(name: "xa2", arg: 4, scope: !135, type: !100, flags: DIFlagArtificial)
!141 = !DILocation(line: 0, scope: !135)
!142 = !DILocation(line: 125, column: 3, scope: !135)
!143 = !{!144}
