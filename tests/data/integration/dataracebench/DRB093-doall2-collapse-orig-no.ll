; ModuleID = 'integration/dataracebench/DRB093-doall2-collapse-orig-no.c'
source_filename = "integration/dataracebench/DRB093-doall2-collapse-orig-no.c"
...
@1 = private unnamed_addr constant [72 x i8] c";integration/dataracebench/DRB093-doall2-collapse-orig-no.c;main;56;1;;\00", align 1
@a = common dso_local global [100 x [100 x i32]] zeroinitializer, align 16, !dbg !0
@2 = private unnamed_addr constant [73 x i8] c";integration/dataracebench/DRB093-doall2-collapse-orig-no.c;main;56;37;;\00", align 1
...
entry:
  ...
  store i8* getelementptr inbounds ([72 x i8], [72 x i8]* @1, i32 0, i32 0), i8** %4, align 8, !dbg !23, !tbaa !24
...
entry:
  ...
  store i32 9999, i32* %.omp.ub, align 4, !dbg !52, !tbaa !53
  ...
  %8 = bitcast i32* %j to i8*, !dbg !51
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %8) #4, !dbg !51
  call void @llvm.dbg.declare(metadata i32* %j, metadata !48, metadata !DIExpression()), !dbg !50
  %9 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !51
  store i8* getelementptr inbounds ([72 x i8], [72 x i8]* @1, i32 0, i32 0), i8** %9, align 8, !dbg !51, !tbaa !24
  ...
  %cmp = icmp sgt i32 %12, 9999, !dbg !52
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ 9999, %cond.true ], [ %13, %cond.false ], !dbg !52
...
omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %cond.end
  ...
  %cmp2 = icmp sle i32 %15, %16, !dbg !51
  br i1 %cmp2, label %omp.inner.for.body, label %omp.inner.for.cond.cleanup, !dbg !51
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %div = sdiv i32 %17, 100, !dbg !54
  %mul = mul nsw i32 %div, 1, !dbg !54
  %add = add nsw i32 0, %mul, !dbg !54
  store i32 %add, i32* %i, align 4, !dbg !54, !tbaa !53
  %18 = load i32, i32* %.omp.iv, align 4, !dbg !52, !tbaa !53
  %19 = load i32, i32* %.omp.iv, align 4, !dbg !52, !tbaa !53
  %div3 = sdiv i32 %19, 100, !dbg !54
  %mul4 = mul nsw i32 %div3, 100, !dbg !54
  %sub = sub nsw i32 %18, %mul4, !dbg !54
  %mul5 = mul nsw i32 %sub, 1, !dbg !55
  %add6 = add nsw i32 0, %mul5, !dbg !55
  store i32 %add6, i32* %j, align 4, !dbg !55, !tbaa !53
  %20 = load i32, i32* %i, align 4, !dbg !56, !tbaa !53
  %idxprom = sext i32 %20 to i64, !dbg !57
  %arrayidx = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @a, i64 0, i64 %idxprom, !dbg !57
  %21 = load i32, i32* %j, align 4, !dbg !58, !tbaa !53
  %idxprom7 = sext i32 %21 to i64, !dbg !57
  %arrayidx8 = getelementptr inbounds [100 x i32], [100 x i32]* %arrayidx, i64 0, i64 %idxprom7, !dbg !57
  %22 = load i32, i32* %arrayidx8, align 4, !dbg !57, !tbaa !53
  %add9 = add nsw i32 %22, 1, !dbg !59
  %23 = load i32, i32* %i, align 4, !dbg !60, !tbaa !53
  %idxprom10 = sext i32 %23 to i64, !dbg !61
  %arrayidx11 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @a, i64 0, i64 %idxprom10, !dbg !61
  %24 = load i32, i32* %j, align 4, !dbg !62, !tbaa !53
  %idxprom12 = sext i32 %24 to i64, !dbg !61
  %arrayidx13 = getelementptr inbounds [100 x i32], [100 x i32]* %arrayidx11, i64 0, i64 %idxprom12, !dbg !61
  store i32 %add9, i32* %arrayidx13, align 4, !dbg !63, !tbaa !53
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  ...
  %add14 = add nsw i32 %25, 1, !dbg !51
  store i32 %add14, i32* %.omp.iv, align 4, !dbg !51, !tbaa !53
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  %26 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !64
  store i8* getelementptr inbounds ([73 x i8], [73 x i8]* @2, i32 0, i32 0), i8** %26, align 8, !dbg !64, !tbaa !24
  call void @__kmpc_for_static_fini(%struct.ident_t* %.kmpc_loc.addr, i32 %11), !dbg !64
  %27 = bitcast i32* %j to i8*, !dbg !64
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %27) #4, !dbg !64
  %28 = bitcast i32* %i to i8*, !dbg !64
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %28) #4, !dbg !64
  %29 = bitcast i32* %.omp.is_last to i8*, !dbg !64
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %29) #4, !dbg !64
  %30 = bitcast i32* %.omp.stride to i8*, !dbg !64
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %30) #4, !dbg !64
  %31 = bitcast i32* %.omp.ub to i8*, !dbg !64
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %31) #4, !dbg !64
  %32 = bitcast i32* %.omp.lb to i8*, !dbg !64
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %32) #4, !dbg !64
  %33 = bitcast i32* %.omp.iv to i8*, !dbg !64
...
entry:
  ...
  %0 = load i32*, i32** %.global_tid..addr, align 8, !dbg !73, !tbaa !49
  %1 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !73, !tbaa !49
...
!3 = !DIFile(filename: "integration/dataracebench/DRB093-doall2-collapse-orig-no.c", directory: "/home/brad/Code/OpenRace/tests/data")
!4 = !{}
!5 = !{!0}
...
!14 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 53, type: !15, scopeLine: 54, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !17)
!15 = !DISubroutineType(types: !16)
!16 = !{!7}
!17 = !{!18, !19}
!18 = !DILocalVariable(name: "i", scope: !14, file: !3, line: 55, type: !7)
!19 = !DILocalVariable(name: "j", scope: !14, file: !3, line: 55, type: !7)
!20 = !DILocation(line: 55, column: 3, scope: !14)
!21 = !DILocation(line: 55, column: 7, scope: !14)
!22 = !DILocation(line: 55, column: 9, scope: !14)
...
!30 = !DILocation(line: 61, column: 1, scope: !14)
!31 = !DILocation(line: 60, column: 3, scope: !14)
!32 = distinct !DISubprogram(name: ".omp_outlined._debug__", scope: !3, file: !3, line: 57, type: !33, scopeLine: 57, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !39)
...
!48 = !DILocalVariable(name: "j", scope: !32, type: !7, flags: DIFlagArtificial)
!49 = !{!29, !29, i64 0}
!50 = !DILocation(line: 0, scope: !32)
!51 = !DILocation(line: 57, column: 3, scope: !32)
!52 = !DILocation(line: 57, column: 8, scope: !32)
!53 = !{!26, !26, i64 0}
!54 = !DILocation(line: 57, column: 18, scope: !32)
!55 = !DILocation(line: 58, column: 20, scope: !32)
!56 = !DILocation(line: 59, column: 17, scope: !32)
!57 = !DILocation(line: 59, column: 15, scope: !32)
!58 = !DILocation(line: 59, column: 20, scope: !32)
!59 = !DILocation(line: 59, column: 22, scope: !32)
!60 = !DILocation(line: 59, column: 9, scope: !32)
!61 = !DILocation(line: 59, column: 7, scope: !32)
!62 = !DILocation(line: 59, column: 12, scope: !32)
!63 = !DILocation(line: 59, column: 14, scope: !32)
!64 = !DILocation(line: 56, column: 1, scope: !32)
!65 = distinct !{!65, !64, !66}
!66 = !DILocation(line: 56, column: 37, scope: !32)
!67 = !DILocation(line: 59, column: 23, scope: !32)
!68 = distinct !DISubprogram(name: ".omp_outlined.", scope: !3, file: !3, line: 57, type: !33, scopeLine: 57, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !69)
!69 = !{!70, !71}
!70 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !68, type: !35, flags: DIFlagArtificial)
!71 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !68, type: !35, flags: DIFlagArtificial)
!72 = !DILocation(line: 0, scope: !68)
!73 = !DILocation(line: 57, column: 3, scope: !68)
!74 = !{!75}
