; ModuleID = 'integration/openmp/get-thread-num-no.c'
source_filename = "integration/openmp/get-thread-num-no.c"
...
@1 = private unnamed_addr constant [51 x i8] c";integration/openmp/get-thread-num-no.c;main;7;1;;\00", align 1
...
entry:
  ...
  store i8* getelementptr inbounds ([51 x i8], [51 x i8]* @1, i32 0, i32 0), i8** %3, align 8, !dbg !22, !tbaa !23
...
!1 = !DIFile(filename: "integration/openmp/get-thread-num-no.c", directory: "/home/brad/Code/OpenRace/tests/data")
!2 = !{}
!3 = !{!4}
