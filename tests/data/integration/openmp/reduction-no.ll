; ModuleID = 'integration/openmp/reduction-no.c'
source_filename = "integration/openmp/reduction-no.c"
...
@1 = private unnamed_addr constant [46 x i8] c";integration/openmp/reduction-no.c;main;9;1;;\00", align 1
@2 = private unnamed_addr constant [47 x i8] c";integration/openmp/reduction-no.c;main;9;39;;\00", align 1
@.gomp_critical_user_.reduction.var = common global [8 x i32] zeroinitializer
@3 = private unnamed_addr constant [47 x i8] c";integration/openmp/reduction-no.c;main;14;1;;\00", align 1
@4 = private unnamed_addr constant [48 x i8] c";integration/openmp/reduction-no.c;main;14;39;;\00", align 1
...
@6 = private unnamed_addr constant [46 x i8] c";integration/openmp/reduction-no.c;main;7;1;;\00", align 1
...
entry:
  ...
  store i8* getelementptr inbounds ([46 x i8], [46 x i8]* @6, i32 0, i32 0), i8** %4, align 8, !dbg !23, !tbaa !24
...
entry:
  ...
  store i8* getelementptr inbounds ([46 x i8], [46 x i8]* @1, i32 0, i32 0), i8** %11, align 8, !dbg !65, !tbaa !24
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  store i8* getelementptr inbounds ([47 x i8], [47 x i8]* @2, i32 0, i32 0), i8** %22, align 8, !dbg !74, !tbaa !24
  ...
  store i8* getelementptr inbounds ([47 x i8], [47 x i8]* @2, i32 0, i32 0), i8** %25, align 8, !dbg !74, !tbaa !24
  %26 = bitcast [1 x i8*]* %.omp.reduction.red_list to i8*, !dbg !74
  %27 = call i32 @__kmpc_reduce(%struct.ident_t* %.kmpc_loc.addr, i32 %13, i32 1, i64 8, i8* %26, void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var), !dbg !74
...
.omp.reduction.case1:                             ; preds = %omp.loop.exit
  ...
  call void @__kmpc_end_reduce(%struct.ident_t* %.kmpc_loc.addr, i32 %13, [8 x i32]* @.gomp_critical_user_.reduction.var), !dbg !74
...
.omp.reduction.default:                           ; preds = %.omp.reduction.case2, %.omp.reduction.case1, %omp.loop.exit
  ...
  %39 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !76
  store i8* getelementptr inbounds ([46 x i8], [46 x i8]* @1, i32 0, i32 0), i8** %39, align 8, !dbg !76, !tbaa !24
  call void @__kmpc_barrier(%struct.ident_t* %.kmpc_loc.addr, i32 %13), !dbg !76
  %40 = bitcast i32* %.omp.iv5 to i8*, !dbg !78
  ...
  %41 = bitcast i32* %.omp.lb7 to i8*, !dbg !78
  ...
  %42 = bitcast i32* %.omp.ub8 to i8*, !dbg !78
  ...
  %43 = bitcast i32* %.omp.stride9 to i8*, !dbg !78
  ...
  %44 = bitcast i32* %.omp.is_last10 to i8*, !dbg !78
  ...
  %45 = bitcast i32* %counter11 to i8*, !dbg !78
  ...
  %46 = bitcast i32* %i12 to i8*, !dbg !78
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %46) #5, !dbg !78
  call void @llvm.dbg.declare(metadata i32* %i12, metadata !59, metadata !DIExpression()), !dbg !79
  %47 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !78
  store i8* getelementptr inbounds ([47 x i8], [47 x i8]* @3, i32 0, i32 0), i8** %47, align 8, !dbg !78, !tbaa !24
  ...
  %cmp13 = icmp sgt i32 %48, 9999, !dbg !80
...
cond.false15:                                     ; preds = %.omp.reduction.default
  %49 = load i32, i32* %.omp.ub8, align 4, !dbg !80, !tbaa !17
  br label %cond.end16, !dbg !80

cond.end16:                                       ; preds = %cond.false15, %cond.true14
  %cond17 = phi i32 [ 9999, %cond.true14 ], [ %49, %cond.false15 ], !dbg !80
  store i32 %cond17, i32* %.omp.ub8, align 4, !dbg !80, !tbaa !17
  %50 = load i32, i32* %.omp.lb7, align 4, !dbg !80, !tbaa !17
  store i32 %50, i32* %.omp.iv5, align 4, !dbg !80, !tbaa !17
  br label %omp.inner.for.cond18, !dbg !78

omp.inner.for.cond18:                             ; preds = %omp.inner.for.inc26, %cond.end16
  %51 = load i32, i32* %.omp.iv5, align 4, !dbg !80, !tbaa !17
  %52 = load i32, i32* %.omp.ub8, align 4, !dbg !80, !tbaa !17
  %cmp19 = icmp sle i32 %51, %52, !dbg !82
...
omp.inner.for.body21:                             ; preds = %omp.inner.for.cond18
  %53 = load i32, i32* %.omp.iv5, align 4, !dbg !80, !tbaa !17
  %mul22 = mul nsw i32 %53, 1, !dbg !83
  %add23 = add nsw i32 0, %mul22, !dbg !83
  store i32 %add23, i32* %i12, align 4, !dbg !83, !tbaa !17
  %54 = load i32, i32* %counter11, align 4, !dbg !84, !tbaa !17
  %inc24 = add nsw i32 %54, 1, !dbg !84
...
omp.inner.for.inc26:                              ; preds = %omp.body.continue25
  %55 = load i32, i32* %.omp.iv5, align 4, !dbg !80, !tbaa !17
  %add27 = add nsw i32 %55, 1, !dbg !82
...
omp.loop.exit29:                                  ; preds = %omp.inner.for.end28
  %56 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !87
  store i8* getelementptr inbounds ([48 x i8], [48 x i8]* @4, i32 0, i32 0), i8** %56, align 8, !dbg !87, !tbaa !24
  call void @__kmpc_for_static_fini(%struct.ident_t* %.kmpc_loc.addr, i32 %13), !dbg !87
  %57 = getelementptr inbounds [1 x i8*], [1 x i8*]* %.omp.reduction.red_list30, i64 0, i64 0, !dbg !87
  %58 = bitcast i32* %counter11 to i8*, !dbg !87
  store i8* %58, i8** %57, align 8, !dbg !87
  %59 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !87
  store i8* getelementptr inbounds ([48 x i8], [48 x i8]* @4, i32 0, i32 0), i8** %59, align 8, !dbg !87, !tbaa !24
  %60 = bitcast [1 x i8*]* %.omp.reduction.red_list30 to i8*, !dbg !87
  %61 = call i32 @__kmpc_reduce(%struct.ident_t* %.kmpc_loc.addr, i32 %13, i32 1, i64 8, i8* %60, void (i8*, i8*)* @.omp.reduction.reduction_func.1, [8 x i32]* @.gomp_critical_user_.reduction.var), !dbg !87
  switch i32 %61, label %.omp.reduction.default34 [
    i32 1, label %.omp.reduction.case131
    i32 2, label %.omp.reduction.case233
  ], !dbg !87

.omp.reduction.case131:                           ; preds = %omp.loop.exit29
  %62 = load i32, i32* %2, align 4, !dbg !81, !tbaa !17
  %63 = load i32, i32* %counter11, align 4, !dbg !81, !tbaa !17
  %add32 = add nsw i32 %62, %63, !dbg !90
  store i32 %add32, i32* %2, align 4, !dbg !90, !tbaa !17
  call void @__kmpc_end_reduce(%struct.ident_t* %.kmpc_loc.addr, i32 %13, [8 x i32]* @.gomp_critical_user_.reduction.var), !dbg !87
  br label %.omp.reduction.default34, !dbg !87

.omp.reduction.case233:                           ; preds = %omp.loop.exit29
  %64 = load i32, i32* %counter11, align 4, !dbg !81, !tbaa !17
  %65 = atomicrmw add i32* %2, i32 %64 monotonic, !dbg !87
  call void @__kmpc_end_reduce(%struct.ident_t* %.kmpc_loc.addr, i32 %13, [8 x i32]* @.gomp_critical_user_.reduction.var), !dbg !87
  br label %.omp.reduction.default34, !dbg !87

.omp.reduction.default34:                         ; preds = %.omp.reduction.case233, %.omp.reduction.case131, %omp.loop.exit29
  %66 = bitcast i32* %i12 to i8*, !dbg !87
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %66) #5, !dbg !87
  %67 = bitcast i32* %counter11 to i8*, !dbg !87
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %67) #5, !dbg !87
  %68 = bitcast i32* %.omp.is_last10 to i8*, !dbg !87
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %68) #5, !dbg !87
  %69 = bitcast i32* %.omp.stride9 to i8*, !dbg !87
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %69) #5, !dbg !87
  %70 = bitcast i32* %.omp.ub8 to i8*, !dbg !87
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %70) #5, !dbg !87
  %71 = bitcast i32* %.omp.lb7 to i8*, !dbg !87
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %71) #5, !dbg !87
  %72 = bitcast i32* %.omp.iv5 to i8*, !dbg !87
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %72) #5, !dbg !87
  %73 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !89
  store i8* getelementptr inbounds ([47 x i8], [47 x i8]* @3, i32 0, i32 0), i8** %73, align 8, !dbg !89, !tbaa !24
  call void @__kmpc_barrier(%struct.ident_t* %.kmpc_loc.addr, i32 %13), !dbg !89
  ret void, !dbg !91
}
...
!1 = !DIFile(filename: "integration/openmp/reduction-no.c", directory: "/home/brad/Code/OpenRace/tests/data")
!2 = !{}
...
!14 = !DILocalVariable(name: "counter", scope: !7, file: !1, line: 5, type: !10)
...
!28 = !DILocation(line: 20, column: 3, scope: !7)
!29 = !DILocation(line: 21, column: 1, scope: !7)
!30 = distinct !DISubprogram(name: ".omp_outlined._debug__", scope: !1, file: !1, line: 8, type: !31, scopeLine: 8, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !38)
...
!41 = !DILocalVariable(name: "counter", arg: 3, scope: !30, file: !1, line: 5, type: !36)
!42 = !DILocalVariable(name: "N", arg: 4, scope: !30, file: !1, line: 4, type: !37)
...
!45 = distinct !DILexicalBlock(scope: !30, file: !1, line: 8, column: 3)
...
!53 = distinct !DILexicalBlock(scope: !45, file: !1, line: 14, column: 1)
...
!62 = !DILocation(line: 5, column: 7, scope: !30)
!63 = !DILocation(line: 4, column: 13, scope: !30)
!64 = !DILocation(line: 8, column: 3, scope: !30)
!65 = !DILocation(line: 9, column: 1, scope: !45)
!66 = !DILocation(line: 0, scope: !44)
!67 = !DILocation(line: 10, column: 10, scope: !44)
!68 = !DILocation(line: 9, column: 31, scope: !44)
!69 = !DILocation(line: 10, column: 5, scope: !44)
!70 = !DILocation(line: 10, column: 28, scope: !44)
!71 = !DILocation(line: 11, column: 14, scope: !72)
!72 = distinct !DILexicalBlock(scope: !44, file: !1, line: 10, column: 33)
!73 = !DILocation(line: 12, column: 5, scope: !72)
!74 = !DILocation(line: 9, column: 1, scope: !44)
!75 = distinct !{!75, !74, !76}
!76 = !DILocation(line: 9, column: 39, scope: !44)
!77 = !DILocation(line: 9, column: 27, scope: !44)
!78 = !DILocation(line: 14, column: 1, scope: !45)
!79 = !DILocation(line: 0, scope: !53)
!80 = !DILocation(line: 15, column: 10, scope: !53)
!81 = !DILocation(line: 14, column: 31, scope: !53)
!82 = !DILocation(line: 15, column: 5, scope: !53)
!83 = !DILocation(line: 15, column: 28, scope: !53)
!84 = !DILocation(line: 16, column: 14, scope: !85)
!85 = distinct !DILexicalBlock(scope: !53, file: !1, line: 15, column: 33)
!86 = !DILocation(line: 17, column: 5, scope: !85)
!87 = !DILocation(line: 14, column: 1, scope: !53)
!88 = distinct !{!88, !87, !89}
!89 = !DILocation(line: 14, column: 39, scope: !53)
!90 = !DILocation(line: 14, column: 27, scope: !53)
!91 = !DILocation(line: 18, column: 3, scope: !30)
!92 = distinct !DISubprogram(linkageName: ".omp.reduction.reduction_func", scope: !1, file: !1, line: 9, type: !93, scopeLine: 9, flags: DIFlagArtificial | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !94)
...
!99 = !DILocation(line: 9, column: 39, scope: !92)
!100 = !DILocation(line: 9, column: 31, scope: !92)
!101 = !DILocation(line: 9, column: 27, scope: !92)
!102 = distinct !DISubprogram(linkageName: ".omp.reduction.reduction_func.1", scope: !1, file: !1, line: 14, type: !93, scopeLine: 14, flags: DIFlagArtificial | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !103)
!103 = !{!104, !105}
...
!107 = !DILocation(line: 14, column: 39, scope: !102)
!108 = !DILocation(line: 14, column: 31, scope: !102)
!109 = !DILocation(line: 14, column: 27, scope: !102)
!110 = distinct !DISubprogram(name: ".omp_outlined.", scope: !1, file: !1, line: 8, type: !31, scopeLine: 8, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !111)
!111 = !{!112, !113, !114, !115}
...
!117 = !DILocation(line: 8, column: 3, scope: !110)
!118 = !{!119}
