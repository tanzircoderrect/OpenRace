; ModuleID = 'reduction-no.c'
source_filename = "reduction-no.c"
...
@1 = private unnamed_addr constant [27 x i8] c";reduction-no.c;main;9;1;;\00", align 1
@2 = private unnamed_addr constant [28 x i8] c";reduction-no.c;main;9;39;;\00", align 1
@.gomp_critical_user_.reduction.var = common global [8 x i32] zeroinitializer
@3 = private unnamed_addr constant [28 x i8] c";reduction-no.c;main;14;1;;\00", align 1
@4 = private unnamed_addr constant [29 x i8] c";reduction-no.c;main;14;39;;\00", align 1
...
@6 = private unnamed_addr constant [27 x i8] c";reduction-no.c;main;7;1;;\00", align 1
...
entry:
  ...
  store i8* getelementptr inbounds ([27 x i8], [27 x i8]* @6, i32 0, i32 0), i8** %2, align 8, !dbg !16
...
entry:
  ...
  store i8* getelementptr inbounds ([27 x i8], [27 x i8]* @1, i32 0, i32 0), i8** %4, align 8, !dbg !48
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  store i8* getelementptr inbounds ([28 x i8], [28 x i8]* @2, i32 0, i32 0), i8** %15, align 8, !dbg !54
  ...
  store i8* getelementptr inbounds ([28 x i8], [28 x i8]* @2, i32 0, i32 0), i8** %18, align 8, !dbg !54
  %19 = bitcast [1 x i8*]* %.omp.reduction.red_list to i8*, !dbg !54
  %20 = call i32 @__kmpc_reduce(%struct.ident_t* %.kmpc_loc.addr, i32 %6, i32 1, i64 8, i8* %19, void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var), !dbg !54
...
.omp.reduction.case1:                             ; preds = %omp.loop.exit
  ...
  call void @__kmpc_end_reduce(%struct.ident_t* %.kmpc_loc.addr, i32 %6, [8 x i32]* @.gomp_critical_user_.reduction.var), !dbg !54
...
.omp.reduction.default:                           ; preds = %.omp.reduction.case2, %.omp.reduction.case1, %omp.loop.exit
  %25 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !56
  store i8* getelementptr inbounds ([27 x i8], [27 x i8]* @1, i32 0, i32 0), i8** %25, align 8, !dbg !56
  call void @__kmpc_barrier(%struct.ident_t* %.kmpc_loc.addr, i32 %6), !dbg !56
  ...
  store i8* getelementptr inbounds ([28 x i8], [28 x i8]* @3, i32 0, i32 0), i8** %26, align 8, !dbg !69
  ...
  %cmp13 = icmp sgt i32 %27, 9999, !dbg !62
...
cond.false15:                                     ; preds = %.omp.reduction.default
  %28 = load i32, i32* %.omp.ub8, align 4, !dbg !62
  br label %cond.end16, !dbg !62

cond.end16:                                       ; preds = %cond.false15, %cond.true14
  %cond17 = phi i32 [ 9999, %cond.true14 ], [ %28, %cond.false15 ], !dbg !62
  store i32 %cond17, i32* %.omp.ub8, align 4, !dbg !62
  %29 = load i32, i32* %.omp.lb7, align 4, !dbg !62
  store i32 %29, i32* %.omp.iv5, align 4, !dbg !62
  br label %omp.inner.for.cond18, !dbg !69

omp.inner.for.cond18:                             ; preds = %omp.inner.for.inc25, %cond.end16
  %30 = load i32, i32* %.omp.iv5, align 4, !dbg !62
  %31 = load i32, i32* %.omp.ub8, align 4, !dbg !62
  %cmp19 = icmp sle i32 %30, %31, !dbg !70
  br i1 %cmp19, label %omp.inner.for.body20, label %omp.inner.for.end27, !dbg !69

omp.inner.for.body20:                             ; preds = %omp.inner.for.cond18
  %32 = load i32, i32* %.omp.iv5, align 4, !dbg !62
  %mul21 = mul nsw i32 %32, 1, !dbg !71
  %add22 = add nsw i32 0, %mul21, !dbg !71
  store i32 %add22, i32* %i12, align 4, !dbg !71
  %33 = load i32, i32* %counter11, align 4, !dbg !72
  %inc23 = add nsw i32 %33, 1, !dbg !72
...
omp.inner.for.inc25:                              ; preds = %omp.body.continue24
  %34 = load i32, i32* %.omp.iv5, align 4, !dbg !62
  %add26 = add nsw i32 %34, 1, !dbg !70
...
omp.loop.exit28:                                  ; preds = %omp.inner.for.end27
  %35 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !75
  store i8* getelementptr inbounds ([29 x i8], [29 x i8]* @4, i32 0, i32 0), i8** %35, align 8, !dbg !75
  call void @__kmpc_for_static_fini(%struct.ident_t* %.kmpc_loc.addr, i32 %6), !dbg !75
  %36 = getelementptr inbounds [1 x i8*], [1 x i8*]* %.omp.reduction.red_list29, i64 0, i64 0, !dbg !75
  %37 = bitcast i32* %counter11 to i8*, !dbg !75
  store i8* %37, i8** %36, align 8, !dbg !75
  %38 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !75
  store i8* getelementptr inbounds ([29 x i8], [29 x i8]* @4, i32 0, i32 0), i8** %38, align 8, !dbg !75
  %39 = bitcast [1 x i8*]* %.omp.reduction.red_list29 to i8*, !dbg !75
  %40 = call i32 @__kmpc_reduce(%struct.ident_t* %.kmpc_loc.addr, i32 %6, i32 1, i64 8, i8* %39, void (i8*, i8*)* @.omp.reduction.reduction_func.1, [8 x i32]* @.gomp_critical_user_.reduction.var), !dbg !75
  switch i32 %40, label %.omp.reduction.default33 [
...
.omp.reduction.case130:                           ; preds = %omp.loop.exit28
  ...
  %add31 = add nsw i32 %41, %42, !dbg !78
  store i32 %add31, i32* %2, align 4, !dbg !78
  call void @__kmpc_end_reduce(%struct.ident_t* %.kmpc_loc.addr, i32 %6, [8 x i32]* @.gomp_critical_user_.reduction.var), !dbg !75
  br label %.omp.reduction.default33, !dbg !75

.omp.reduction.case232:                           ; preds = %omp.loop.exit28
  %43 = load i32, i32* %counter11, align 4, !dbg !67
  %44 = atomicrmw add i32* %2, i32 %43 monotonic, !dbg !75
  call void @__kmpc_end_reduce(%struct.ident_t* %.kmpc_loc.addr, i32 %6, [8 x i32]* @.gomp_critical_user_.reduction.var), !dbg !75
  br label %.omp.reduction.default33, !dbg !75

.omp.reduction.default33:                         ; preds = %.omp.reduction.case232, %.omp.reduction.case130, %omp.loop.exit28
  %45 = getelementptr inbounds %struct.ident_t, %struct.ident_t* %.kmpc_loc.addr, i32 0, i32 4, !dbg !77
  store i8* getelementptr inbounds ([28 x i8], [28 x i8]* @3, i32 0, i32 0), i8** %45, align 8, !dbg !77
...
!1 = !DIFile(filename: "reduction-no.c", directory: "/home/brad/Code/OpenRace/tests/data/integration/openmp")
!2 = !{}
...
!13 = !DILocation(line: 4, column: 13, scope: !7)
...
!17 = !DILocation(line: 20, column: 18, scope: !7)
!18 = !DILocation(line: 20, column: 3, scope: !7)
!19 = !DILocation(line: 21, column: 1, scope: !7)
!20 = distinct !DISubprogram(name: ".omp_outlined._debug__", scope: !1, file: !1, line: 8, type: !21, scopeLine: 8, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
...
!31 = !DILocalVariable(name: "counter", arg: 3, scope: !20, file: !1, line: 5, type: !26)
!32 = !DILocation(line: 5, column: 7, scope: !20)
!33 = !DILocalVariable(name: "N", arg: 4, scope: !20, file: !1, line: 4, type: !27)
!34 = !DILocation(line: 4, column: 13, scope: !20)
!35 = !DILocation(line: 8, column: 3, scope: !20)
!36 = !DILocalVariable(name: ".omp.iv", scope: !37, type: !10, flags: DIFlagArtificial)
!37 = distinct !DILexicalBlock(scope: !38, file: !1, line: 9, column: 1)
!38 = distinct !DILexicalBlock(scope: !20, file: !1, line: 8, column: 3)
!39 = !DILocation(line: 0, scope: !37)
!40 = !DILocalVariable(name: ".omp.lb", scope: !37, type: !10, flags: DIFlagArtificial)
!41 = !DILocation(line: 10, column: 10, scope: !37)
...
!46 = !DILocation(line: 9, column: 31, scope: !37)
!47 = !DILocalVariable(name: "i", scope: !37, type: !10, flags: DIFlagArtificial)
!48 = !DILocation(line: 9, column: 1, scope: !38)
!49 = !DILocation(line: 10, column: 5, scope: !37)
!50 = !DILocation(line: 10, column: 28, scope: !37)
!51 = !DILocation(line: 11, column: 14, scope: !52)
!52 = distinct !DILexicalBlock(scope: !37, file: !1, line: 10, column: 33)
!53 = !DILocation(line: 12, column: 5, scope: !52)
!54 = !DILocation(line: 9, column: 1, scope: !37)
!55 = distinct !{!55, !54, !56}
!56 = !DILocation(line: 9, column: 39, scope: !37)
!57 = !DILocation(line: 9, column: 27, scope: !37)
!58 = !DILocalVariable(name: ".omp.iv", scope: !59, type: !10, flags: DIFlagArtificial)
!59 = distinct !DILexicalBlock(scope: !38, file: !1, line: 14, column: 1)
!60 = !DILocation(line: 0, scope: !59)
!61 = !DILocalVariable(name: ".omp.lb", scope: !59, type: !10, flags: DIFlagArtificial)
!62 = !DILocation(line: 15, column: 10, scope: !59)
...
!67 = !DILocation(line: 14, column: 31, scope: !59)
!68 = !DILocalVariable(name: "i", scope: !59, type: !10, flags: DIFlagArtificial)
!69 = !DILocation(line: 14, column: 1, scope: !38)
!70 = !DILocation(line: 15, column: 5, scope: !59)
!71 = !DILocation(line: 15, column: 28, scope: !59)
!72 = !DILocation(line: 16, column: 14, scope: !73)
!73 = distinct !DILexicalBlock(scope: !59, file: !1, line: 15, column: 33)
!74 = !DILocation(line: 17, column: 5, scope: !73)
!75 = !DILocation(line: 14, column: 1, scope: !59)
!76 = distinct !{!76, !75, !77}
!77 = !DILocation(line: 14, column: 39, scope: !59)
!78 = !DILocation(line: 14, column: 27, scope: !59)
!79 = !DILocation(line: 18, column: 3, scope: !20)
!80 = distinct !DISubprogram(linkageName: ".omp.reduction.reduction_func", scope: !1, file: !1, line: 9, type: !81, scopeLine: 9, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
...
!86 = !DILocation(line: 9, column: 39, scope: !80)
!87 = !DILocation(line: 9, column: 31, scope: !80)
!88 = !DILocation(line: 9, column: 27, scope: !80)
!89 = distinct !DISubprogram(linkageName: ".omp.reduction.reduction_func.1", scope: !1, file: !1, line: 14, type: !81, scopeLine: 14, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
...
!93 = !DILocation(line: 14, column: 39, scope: !89)
!94 = !DILocation(line: 14, column: 31, scope: !89)
!95 = !DILocation(line: 14, column: 27, scope: !89)
!96 = distinct !DISubprogram(name: ".omp_outlined.", scope: !1, file: !1, line: 8, type: !21, scopeLine: 8, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !2)
...
!102 = !DILocation(line: 8, column: 3, scope: !96)
!103 = !{!104}
