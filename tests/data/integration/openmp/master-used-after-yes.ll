; ModuleID = 'integration/openmp/master-used-after-yes.c'
source_filename = "integration/openmp/master-used-after-yes.c"
...
entry:
  ...
  store i8* getelementptr inbounds ([55 x i8], [55 x i8]* @2, i32 0, i32 0), i8** %3, align 8, !dbg !19, !tbaa !20
...
entry:
  ...
  store i8* getelementptr inbounds ([55 x i8], [55 x i8]* @1, i32 0, i32 0), i8** %3, align 8, !dbg !41, !tbaa !20
  %4 = load i32*, i32** %.global_tid..addr, align 8, !dbg !41
  %5 = load i32, i32* %4, align 4, !dbg !41, !tbaa !15
  %6 = call i32 @__kmpc_master(%struct.ident_t* %.kmpc_loc.addr, i32 %5), !dbg !41
  %7 = icmp ne i32 %6, 0, !dbg !41
  br i1 %7, label %omp_if.then, label %omp_if.end, !dbg !41

omp_if.then:                                      ; preds = %entry
  store i32 1, i32* %2, align 4, !dbg !43, !tbaa !15
  call void @__kmpc_end_master(%struct.ident_t* %.kmpc_loc.addr, i32 %5), !dbg !46
...
; Function Attrs: norecurse nounwind uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid., i32* dereferenceable(4) %x) #3 !dbg !50 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %x.addr = alloca i32*, align 8
  ...
  store i32* %x, i32** %x.addr, align 8, !tbaa !37
  call void @llvm.dbg.declare(metadata i32** %x.addr, metadata !54, metadata !DIExpression()), !dbg !55
  %0 = load i32*, i32** %x.addr, align 8, !dbg !56, !tbaa !37
  %1 = load i32*, i32** %.global_tid..addr, align 8, !dbg !56, !tbaa !37
  %2 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !56, !tbaa !37
  %3 = load i32*, i32** %x.addr, align 8, !dbg !56, !tbaa !37
...
!1 = !DIFile(filename: "integration/openmp/master-used-after-yes.c", directory: "/home/addisoncrump/git/OpenRace/tests/data")
!2 = !{}
...
!51 = !{!52, !53, !54}
!52 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !50, type: !28, flags: DIFlagArtificial)
!53 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !50, type: !28, flags: DIFlagArtificial)
!54 = !DILocalVariable(name: "x", arg: 3, scope: !50, type: !32, flags: DIFlagArtificial)
!55 = !DILocation(line: 0, scope: !50)
!56 = !DILocation(line: 8, column: 3, scope: !50)
!57 = !{!58}
